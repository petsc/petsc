...
class Configure(config.base.Configure):
  ...
  def configurePIC(self):
    ...
    if (self.framework.argDB['PETSC_ARCH_BASE'].startswith('hpux') or self.framework.argDB['PETSC_ARCH_BASE'].startswith('hpux')) and not config.setCompilers.Configure.isGNU(self.framework.argDB['CC']):
      return
    languages = ['C']
