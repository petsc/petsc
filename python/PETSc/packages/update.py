...
##    self.host_os     = results['host_os']
    ...
    if os.path.isdir(os.path.join('bmake',self.framework.argDB['PETSC_DIR'])) and not os.path.isfile(os.path.join('bmake',self.framework.argDB['PETSC_ARCH'],'configure.py')):
