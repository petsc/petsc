...
all-gnumake-local: chk_makej info gnumake matlabbin mpi4py-build petsc4py-build libmesh-build
...
install:
	...
	${OMAKE} PETSC_ARCH=${PETSC_ARCH} PETSC_DIR=${PETSC_DIR} mpi4py-install petsc4py-install libmesh-install
