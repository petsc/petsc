...
# basic gcc tests
./config/asterix.py
make PETSC_ARCH=asterix all alltests tests_DATAFILESPATH DATAFILESPATH=/home/balay/datafiles 
make PETSC_ARCH=asterix tests_DATAFILESPATH DATAFILESPATH=/home/balay/datafiles
...
make PETSC_ARCH=asterix-openmpi all alltests tests_DATAFILESPATH DATAFILESPATH=/home/balay/datafiles 
...
make PETSC_ARCH=asterix-complex testexamples testfortran tests_DATAFILESPATH DATAFILESPATH=/home/balay/datafiles 
...
--download-umfpack=1
make PETSC_ARCH=asterix-prometheus all test tests_DATAFILESPATH DATAFILESPATH=/home/balay/datafiles
...
make PETSC_ARCH=asterix-intel-opt testexamples testfortran tests_DATAFILESPATH DATAFILESPATH=/home/balay/datafiles
...
make PETSC_ARCH=asterix-c89 all test alltests tests_DATAFILESPATH DATAFILESPATH=/home/balay/datafiles

# basic sun tests
./config/asterix-sun.py
make PETSC_ARCH=asterix-sun all test
./config/asterix-sun.py --with-shared-libraries=1 --with-dynamic-loading=1 -PETSC_ARCH=asterix-sun-dynamic
make PETSC_ARCH=asterix-sun-dynamic all alltests tests_DATAFILESPATH DATAFILESPATH=/home/balay/datafiles
...
./config/asterix-sun.py --with-shared-libraries=1 --with-dynamic-loading=1 --with-scalar-type=complex --with-clanguage=cxx -PETSC_ARCH=asterix-sun-complex-dynamic
