...
./config/asterix-sun.py --with-shared-libraries=1 --with-dynamic-loader=1 -PETSC_ARCH=asterix-sun-dynamic
...
./config/asterix-sun.py --with-shared-libraries=1 --with-dynamic-loader=1 --with-scalar-type=complex --with-clanguage=cxx -PETSC_ARCH=asterix-sun-complex-dynamic
