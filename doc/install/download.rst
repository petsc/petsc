...
- `petsc-3.19.5.tar.gz <https://ftp.mcs.anl.gov/pub/petsc/release-snapshots/petsc-3.19.5.tar.gz>`__

Tarball which includes all documentation, recommended for offline use.

- `petsc-with-docs-3.19.5.tar.gz <https://ftp.mcs.anl.gov/pub/petsc/release-snapshots/petsc-with-docs-3.19.5.tar.gz>`__


Tarball to enable a separate installation of petsc4py.

- `petsc4py-3.19.5.tar.gz  <https://ftp.mcs.anl.gov/pub/petsc/release-snapshots/petsc4py-3.19.5.tar.gz>`__
