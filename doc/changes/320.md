...
- Add `PCGAMGMISkSetAggressive()` to set the number of levels (k) of aggressive MIS-k coarsening (2 is very common)
- Add `PCGAMGMISkSetMinDegreeOrdering()` to use a minimum degree ordering for the (greedy) MIS-k algorithm
