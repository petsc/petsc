...
c
      Double b1bc(5,5,4,ysf1:yefp1,zsf1:zefp1)
      Double b2bc(5,5,xsf1:xefp1,4,zsf1:zefp1)
      Double b2bc_tmp(5,5,xsf1:xefp1,4,zsf1:zefp1)
      Double b3bc(5,5,xsf1:xefp1,ysf1:yefp1,4)
c
c      Double b1bc(5,5,4,nj,nk), b2bc(5,5,ni,4,nk)
c      Double b3bc(5,5,ni,nj,4), b2bc_tmp(5,5,ni,4,nk)
c
