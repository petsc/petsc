/*
  macro expansion:
  function_driver -> adintr_fmax
  exception number -> ADINTR_FMAX
  exceptional code -> 
*fx = ADIntr_Partials[ADINTR_FMAX][ADINTR_FX];
*fy = ADIntr_Partials[ADINTR_FMAX][ADINTR_FY];
...
void
adintr_fmax (int deriv_order, int file_number, int line_number,
		 double*fx, double*fy,...)
{
     ...
     const int exception = ADINTR_FMAX;
