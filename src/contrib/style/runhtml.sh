...
echo "<p>This page is a summary of the output generated by the style checker scripts located in \$PETSC_DIR/src/contrib/style. The purpose of these scripts is to promote closer adherence to the PETSc Style Guide located in the <a href=\"https://petsc.org/release/developers/style" title=\"PETSc Style and Usage Guide\">PETSc Style and Usage Guide</a>. Keep in mind that the scripts may not be perfect and may produce a number of <a href=\"http://en.wikipedia.org/wiki/Type_I_and_type_II_errors\">type I and type II errors</a>.</p>" >> $OUTFILE
