/*
   ...
   running with FCG. Note this only works for symmetric real and Hermitian
   matrices (not complex matrices that are symmetric).
*/
#include <../src/ksp/ksp/impls/fcg/fcgimpl.h>
static PetscErrorCode LINPACKfcgtql1(PetscInt*,PetscReal*,PetscReal*,PetscInt*);

#undef __FUNCT__
#define __FUNCT__ "KSPComputeEigenvalues_FCG"
PetscErrorCode KSPComputeEigenvalues_FCG(KSP ksp,PetscInt nmax,PetscReal *r,PetscReal *c,PetscInt *neig)
{
  KSP_FCG         *fcgP = (KSP_FCG*)ksp->data;
  PetscScalar    *d,*e;
  PetscReal      *ee;
  PetscErrorCode ierr;
  PetscInt       j,n = ksp->its-1;
...
#undef __FUNCT__
#define __FUNCT__ "KSPComputeExtremeSingularValues_FCG"
PetscErrorCode KSPComputeExtremeSingularValues_FCG(KSP ksp,PetscReal *emax,PetscReal *emin)
{
  KSP_FCG      *fcgP = (KSP_FCG*)ksp->data;
  PetscScalar *d,*e;
  PetscReal   *dd,*ee;
  ...
  d = fcgP->d; e = fcgP->e; dd = fcgP->dd; ee = fcgP->ee;
...
static PetscReal LINPACKfcgpthy(PetscReal*,PetscReal*);

#undef __FUNCT__
#define __FUNCT__ "LINPACKfcgtql1"
static PetscErrorCode LINPACKfcgtql1(PetscInt *n,PetscReal *d,PetscReal *e,PetscInt *ierr)
{
...
#undef __FUNCT__
#define __FUNCT__ "LINPACKfcgpthy"
static PetscReal LINPACKfcgpthy(PetscReal *a,PetscReal *b)
{
  /* System generated locals */
