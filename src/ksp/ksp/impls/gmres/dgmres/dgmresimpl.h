...
EXTERN_C_BEGIN
 ...
 extern void LAPACKgges_( const char *, const char *, const char *, void **, PetscBLASInt *, PetscReal *, PetscPetscBLASInt *, PetscReal *, PetscBLASInt *, PetscBLASInt *, PetscReal *, PetscReal *, PetscReal *, PetscBLASInt *, PetscReal *, PetscBLASInt *, PetscReal *, PetscBLASInt *, PetscBLASInt *, PetscBLASInt *);
