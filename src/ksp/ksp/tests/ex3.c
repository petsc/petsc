...
/*TEST
    ...
    test:
      args: -pc_type jacobi -ksp_monitor -m 5 -ksp_orthogonalization_cgs_refinement_type refine_always
    ...
    test:
      ...
      args: -pc_type jacobi -ksp_monitor -m 5 -ksp_orthogonalization_cgs_refinement_type refine_always -mat_type aijkokkos -vec_type kokkos
