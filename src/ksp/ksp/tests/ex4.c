...
/*TEST
    ...
    test:
      args: -ksp_monitor -m 5 -pc_type jacobi -ksp_orthogonalization_cgs_refinement_type refine_always

    test:
      suffix: 3
      args: -pc_type sor -pc_sor_symmetric -ksp_monitor -m 5 -ksp_orthogonalization_cgs_refinement_type refine_always

    test:
      suffix: 5
      args: -pc_type eisenstat -ksp_monitor -m 5 -ksp_orthogonalization_cgs_refinement_type refine_always
