...
const char *const KSPConvergedReasons_Shifted[] = {"DIVERGED_INNER_SOLVE_FAILED", "DIVERGED_USER", "DIVERGED_PC_FAILED", "DIVERGED_INDEFINITE_MAT", "DIVERGED_NANORINF", "DIVERGED_INDEFINITE_PC", "DIVERGED_NONSYMMETRIC", "DIVERGED_BREAKDOWN_BICG", "DIVERGED_BREAKDOWN", "DIVERGED_DTOL", "DIVERGED_ITS", "DIVERGED_NULL", "", "CONVERGED_ITERATING", "CONVERGED_RTOL_NORMAL_EQUATIONS", "CONVERGED_RTOL", "CONVERGED_ATOL", "CONVERGED_ITS", "CONVERGED_NEG_CURVE", "CONVERGED_STEP_LENGTH", "CONVERGED_HAPPY_BREAKDOWN", "CONVERGED_USER", "CONVERGED_ATOL_NORMAL_EQUATIONS", "KSPConvergedReason", "KSP_", NULL};
const char *const *KSPConvergedReasons     = KSPConvergedReasons_Shifted + 13;
...
PetscErrorCode KSPInitializePackage(void)
{
  ...
  PetscCall(PetscLogEventRegister("KSPOrthogonalize", KSP_CLASSID, &KSP_Orthogonalization));
