...
PETSC_EXTERN PetscErrorCode KSPCGCreate_NASH(KSP);
PETSC_EXTERN PetscErrorCode KSPCGCreate_STCG(KSP);
PETSC_EXTERN PetscErrorCode KSPCGCreate_GLTR(KSP);
...
PetscErrorCode  KSPRegisterAll(void)
{
  ...
  ierr = KSPRegister(KSPCGNASH,      KSPCGCreate_NASH);CHKERRQ(ierr);
  ierr = KSPRegister(KSPCGSTCG,      KSPCGCreate_STCG);CHKERRQ(ierr);
  ierr = KSPRegister(KSPCGGLTR,      KSPCGCreate_GLTR);CHKERRQ(ierr);
