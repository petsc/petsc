...
/*TEST
   ...
   test:
      ...
      args: -ksp_monitor -ksp_orthogonalization_cgs_refinement_type refine_always -library_preload
   ...
   test:
      ...
      requires: cuda
      args: -pc_type sor -pc_sor_symmetric -ksp_monitor -ksp_orthogonalization_cgs_refinement_type refine_always -mat_type aijcusparse -vec_type cuda
      args: -ksp_view
   ...
   test:
      ...
      requires: cuda
      args: -pc_type eisenstat -ksp_monitor -ksp_orthogonalization_cgs_refinement_type refine_always -mat_type aijcusparse -vec_type cuda -ksp_view

   test:
      suffix: aijcusparse
      requires: cuda
      args: -ksp_monitor -ksp_orthogonalization_cgs_refinement_type refine_always -mat_type aijcusparse -vec_type cuda -ksp_view
