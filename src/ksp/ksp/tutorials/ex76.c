...
/*TEST
   ...
   testset:
      requires: hpddm slepc datafilespath double !complex !define(PETSC_USE_64BIT_INDICES) define(PETSC_HAVE_DYNAMIC_LIBRARIES) define(PETSC_USE_SHARED_LIBRARIES) mumps define(PETSC_HAVE_OPENMP_SUPPORT)
