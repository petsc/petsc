...
#include <petscksp.h>
  ...
  #define pcshellsetmatapply_            PCSHELLSETMATAPPLY
  ...
  #define pcshellsetmatapplyrichardson_  PCSHELLSETMATAPPLYRICHARDSON
...
static PetscErrorCode ourshellmatapply(PC pc, Mat X, Mat Y)
{
  PetscCallFortranVoidFunction((*(void (*)(PC *, Mat *, Mat *, PetscErrorCode *))(((PetscObject)pc)->fortran_func_pointers[11]))(&pc, &X, &Y, &ierr));
  return PETSC_SUCCESS;
}
...
static PetscErrorCode ourmatapplyrichardson(PC pc, Mat B, Mat Y, Mat W, PetscReal rtol, PetscReal abstol, PetscReal dtol, PetscInt m, PetscBool guesszero, PetscInt *outits, PCRichardsonConvergedReason *reason)
{
  PetscCallFortranVoidFunction((*(void (*)(PC *, Mat *, Mat *, Mat *, PetscReal *, PetscReal *, PetscReal *, PetscInt *, PetscBool *, PetscInt *, PCRichardsonConvergedReason *, PetscErrorCode *))(((PetscObject)pc)->fortran_func_pointers[12]))(&pc, &B, &Y, &W, &rtol, &abstol, &dtol, &m, &guesszero, outits, reason, &ierr));
  return PETSC_SUCCESS;
}
...
{
  PetscObjectAllocateFortranPointers(*pc, 13);
  ((PetscObject)*pc)->fortran_func_pointers[0] = (PetscFortranCallbackFn *)apply;

  *ierr = PCShellSetApply(*pc, ourshellapply);
}

PETSC_EXTERN void pcshellsetmatapply_(PC *pc, void (*matapply)(void *, Mat *, Mat *, PetscErrorCode *), PetscErrorCode *ierr)
{
  PetscObjectAllocateFortranPointers(*pc, 13);
  ((PetscObject)*pc)->fortran_func_pointers[11] = (PetscFortranCallbackFn *)matapply;

  *ierr = PCShellSetMatApply(*pc, ourshellmatapply);
}
...
PETSC_EXTERN void pcshellsetmatapplyrichardson_(PC *pc, void (*matapply)(void *, Mat *, Mat *, Mat *, PetscReal *, PetscReal *, PetscReal *, PetscInt *, PetscBool *, PetscInt *, PCRichardsonConvergedReason *, PetscErrorCode *), PetscErrorCode *ierr)
{
  PetscObjectAllocateFortranPointers(*pc, 13);
  ((PetscObject)*pc)->fortran_func_pointers[12] = (PetscFortranCallbackFn *)matapply;
  *ierr                                         = PCShellSetMatApplyRichardson(*pc, ourmatapplyrichardson);
}
