...
PetscErrorCode PCBDDCSubSchursSetUp(PCBDDCSubSchurs,Mat,Mat,PetscBool,PetscInt[],PetscInt[],PetscInt,PetscBool,PetscBool,PetscBool,PetscBool,PetscInt,PetscInt[],IS[],Mat,IS);
