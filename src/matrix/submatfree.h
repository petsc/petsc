...
PetscErrorCode MatShift_SMF(Mat,PetscScalar);
PetscErrorCode MatDuplicate_SMF(Mat,MatDuplicateOption,Mat*);
PetscErrorCode MatEqual_SMF(Mat,Mat,PetscBool*);
PetscErrorCode MatScale_SMF(Mat,PetscScalar);
PetscErrorCode MatGetSubMatrix_SMF(Mat,IS,IS,MatReuse,Mat *);
PetscErrorCode MatGetSubMatrices_SMF(Mat,PetscInt,IS*,IS*,MatReuse,Mat**);
