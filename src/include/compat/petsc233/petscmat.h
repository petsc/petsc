...
#undef __FUNCT__
#define __FUNCT__ "MatGetSubMatrix_233"
static PETSC_UNUSED
PetscErrorCode MatGetSubMatrix_233(Mat mat,IS isrow,IS iscol,MatReuse cll,Mat *newmat)
{
  MPI_Comm comm;
  PetscMPIInt size;
...
#define MatGetSubMatrix MatGetSubMatrix_233
