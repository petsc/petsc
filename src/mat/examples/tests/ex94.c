...
/*TEST
   ...
   test:
      ...
      requires: datafilespath !complex double !define(PETSC_USE_64BIT_INDICES)
      nsize: 8
      args: -f0 ${DATAFILESPATH}/matrices/arco1_ns -f1 ${DATAFILESPATH}/matrices/arco2 -test_MatAXPY
      output_file: output/ex94_1.out
   ...
   test:
      ...
      requires: datafilespath !complex double !define(PETSC_USE_64BIT_INDICES)
      nsize: 8
      args: -f0 ${DATAFILESPATH}/matrices/arco1_ns -f1 ${DATAFILESPATH}/matrices/arco2 -test_MatAXPY -mat_type baij
      output_file: output/ex94_1.out
   ...
   test:
      ...
      requires: datafilespath !complex double !define(PETSC_USE_64BIT_INDICES)
      nsize: 8
      args: -f0 ${DATAFILESPATH}/matrices/arco1_ns -f1 ${DATAFILESPATH}/matrices/arco2 -test_MatAXPY -mat_type sbaij
      output_file: output/ex94_1.out
