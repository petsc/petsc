...
/*TEST
      ...
      test:
         args: -mat_type aij -f ${PETSC_DIR}/share/petsc/datafiles/matrices/ns-real-int32-float64 -malloc_dump
      ...
      test:
         suffix: 5
         args: -mat_type sbaij -f ${PETSC_DIR}/share/petsc/datafiles/matrices/ns-real-int32-float64 -malloc_dump
         output_file: output/ex180_1.out
         requires: !complex double !define(PETSC_USE_64BIT_INDICES)
      ...
      test:
         suffix: 7
         args: -mat_type sbaij -matload_block_size 4 -f ${PETSC_DIR}/share/petsc/datafiles/matrices/ns-real-int32-float64 -malloc_dump
         output_file: output/ex180_1.out
         requires: !complex double !define(PETSC_USE_64BIT_INDICES)
      ...
      test:
         suffix: 9
         args: -mat_type baij -matload_block_size 4 -f ${PETSC_DIR}/share/petsc/datafiles/matrices/ns-real-int32-float64 -malloc_dump
         output_file: output/ex180_1.out
         requires: !complex double !define(PETSC_USE_64BIT_INDICES)
