static char help[] = "Testing MatCreateMPIAIJWithSplitArrays() and MatCreateSeqSBAIJWithArrays().\n\n";
...
int main(int argc,char **argv) {
  ...
  if (!flg) SETERRQ(PETSC_ERR_ARG_NOTSAMETYPE,"MatMult(A,As) are NOT equal"); 
