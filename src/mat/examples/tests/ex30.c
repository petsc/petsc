/*$Id: ex30.c,v 1.21 2001/01/15 21:46:09 bsmith Exp bsmith $*/
...
int main(int argc,char **args)
{
  ...
  ierr = PetscViewerPushFormat(PETSC_VIEWER_STDOUT_SELF,PETSC_VIEWER_FORMAT_ASCII_INFO,0);CHKERRQ(ierr);
