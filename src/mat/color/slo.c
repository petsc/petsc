...
/* Subroutine */ int slo_(n, indrow, jpntr, indcol, ipntr, ndeg, list, maxclq,
	 iwa1, iwa2, iwa3, iwa4)
integer *n, *indrow, *jpntr, *indcol, *ipntr, *ndeg, *list, *maxclq, *iwa1, *
	iwa2, *iwa3, *iwa4;
{
    ...
    /* Local variables */
    static integer jcol, ic, ip, jp, ir, mindeg, numdeg, numord;
...
/*                 Update the pointers to the current degree l
ists. */
