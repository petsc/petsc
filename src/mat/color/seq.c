...
/* Subroutine */ int seq_(n, indrow, jpntr, indcol, ipntr, list, ngrp, maxgrp,
	 iwa)
integer *n, *indrow, *jpntr, *indcol, *ipntr, *list, *ngrp, *maxgrp, *iwa;
{
    /* System generated locals */
    integer i__1, i__2, i__3;

    /* Local variables */
    static integer jcol, j, ic, ip, jp, ir;
