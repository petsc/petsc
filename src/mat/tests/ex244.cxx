...
int main(int argc,char **args)
{
  ...
  /* Load PETSc matrices */
  CHKERRQ(PetscOptionsGetString(NULL,NULL,"-fA",file[0],PETSC_MAX_PATH_LEN,NULL));
  ...
  CHKERRQ(PetscObjectTypeCompare((PetscObject)A,MATSCALAPACK,&isScaLAPACK));
  if (isScaLAPACK) {
    Ae = A;
    Be = B;
    ...
    CHKERRQ(MatConvert(A, MATSCALAPACK, MAT_INITIAL_MATRIX, &Ae));
    CHKERRQ(MatConvert(B, MATSCALAPACK, MAT_INITIAL_MATRIX, &Be));
