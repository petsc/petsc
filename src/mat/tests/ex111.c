...
int main(int argc,char **argv)
{
  ...
  { /* Test MatMatMatMult_Basic() */
    ...
    PetscAssertFalse(!flg,PETSC_COMM_WORLD,PETSC_ERR_PLIB,"D*v != Cdense*v");
  ...
  PetscAssertFalse(!flg,PETSC_COMM_WORLD,PETSC_ERR_PLIB,"D != C");
  ...
  PetscAssertFalse(!flg,PETSC_COMM_WORLD,PETSC_ERR_PLIB,"C != PtAP");
