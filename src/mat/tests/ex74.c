...
int main(int argc,char **args)
{
  ...
  PetscAssertFalse(!equal,PETSC_COMM_SELF,PETSC_ERR_ARG_NOTSAMETYPE,"Error in MatDuplicate()");
  ...
  PetscAssertFalse(!equal,PETSC_COMM_SELF,PETSC_ERR_ARG_NOTSAMETYPE,"Error in MatDiagonalScale");
  ...
  PetscAssertFalse(!equal,PETSC_COMM_SELF,PETSC_ERR_PLIB,"Error: MatMatMult()");
