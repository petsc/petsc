...
int main(int argc,char **args)
{
  ...
  if (info) SETERRQ(PETSC_COMM_SELF,PETSC_ERR_USER,"LAPACKstebz_ fails. info %d",info);
  ...
  if (info) SETERRQ(PETSC_COMM_SELF,PETSC_ERR_USER,"LAPACKstein_ fails. info %d",info);
  /* View evals */
