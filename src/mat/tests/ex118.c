...
int main(int argc,char **args)
{
  ...
  PetscCheckFalse(info,PETSC_COMM_SELF,PETSC_ERR_USER,"LAPACKstebz_ fails. info %d",info);
  ...
  PetscCheckFalse(info,PETSC_COMM_SELF,PETSC_ERR_USER,"LAPACKstein_ fails. info %d",info);
  /* View evals */
