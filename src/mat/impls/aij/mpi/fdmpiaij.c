  ...
  */
  ...
  for ( i=0; i<nis; i++ ) {
    ...
    if (flg) { /* --------------------------------------------------------------------------------*/
      ...
      int *rowhit = (int *) PetscMalloc( N*sizeof(int) ); CHKPTRQ(rowhit);
      ...
      int currentcol,fm,mfm,*rowhit,*columnsforrow;
