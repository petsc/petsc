...
static PetscErrorCode MatSetFromOptions_SeqAIJCUSPARSE(PetscOptionsObjectType *PetscOptionsObject,Mat);
...
static PetscErrorCode MatSetFromOptions_SeqAIJCUSPARSE(PetscOptionsObjectType *PetscOptionsObject,Mat A)
{
  PetscErrorCode           ierr;
