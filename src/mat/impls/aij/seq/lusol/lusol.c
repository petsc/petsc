...
*/
PETSC_EXTERN_C void PETSC_STDCALL M1PAGE()
{
  ;
}
PETSC_EXTERN_C void PETSC_STDCALL M5SETX()
{
  ;
}

PETSC_EXTERN_C void PETSC_STDCALL M6RDEL()
{
  ;
}

PETSC_EXTERN_C void PETSC_STDCALL LU1FAC(int *m, int *n, int *nnz, int *size, int *luparm,
...
PETSC_EXTERN_C void PETSC_STDCALL LU6SOL(int *mode, int *m, int *n, double *rhs, double *x,
