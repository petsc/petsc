...
extern PetscErrorCode MatMatMultSymbolic_SeqAIJ_SeqAIJ_Scalable_new(Mat,Mat,PetscReal,Mat*);
...
extern PetscErrorCode MatGetSymbolicMatMatMult_SeqAIJ_SeqAIJ(Mat,Mat,PetscReal,PetscInt*[],PetscInt*[],PetscInt*);
