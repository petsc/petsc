...
EXTERN PetscErrorCode MatLUFactorSymbolic_SeqAIJ_newdatastruct_v2(Mat,Mat,IS,IS,const MatFactorInfo*);
...
EXTERN PetscErrorCode MatLUFactorNumeric_SeqAIJ_newdatastruct_v2(Mat,Mat,const MatFactorInfo*);
