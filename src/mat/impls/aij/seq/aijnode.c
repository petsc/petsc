#ifndef lint
static char vcid[] = "$Id: aijnode.c,v 1.66 1996/12/18 17:11:59 balay Exp balay $";
#endif
/*
...
#undef __FUNCTION__  
#define __FUNCTION__ "Mat_AIJ_CreateColInode"
...
*/
#undef __FUNCTION__  
#define __FUNCTION__ "MatGetRowIJ_SeqAIJ_Inode_Symmetric"
...
*/
#undef __FUNCTION__  
#define __FUNCTION__ "MatGetRowIJ_SeqAIJ_Inode_Nonsymmetric"
...
#undef __FUNCTION__  
#define __FUNCTION__ "MatGetRowIJ_SeqAIJ_Inode"
...
#undef __FUNCTION__  
#define __FUNCTION__ "MatRestoreRowIJ_SeqAIJ_Inode"
...
#undef __FUNCTION__  
#define __FUNCTION__ "MatGetColumnIJ_SeqAIJ_Inode_Nonsymmetric"
...
#undef __FUNCTION__  
#define __FUNCTION__ "MatGetColumnIJ_SeqAIJ_Inode"
...
#undef __FUNCTION__  
#define __FUNCTION__ "MatRestoreColumnIJ_SeqAIJ_Inode"
...
#undef __FUNCTION__  
#define __FUNCTION__ "MatMult_SeqAIJ_Inode"
...
#undef __FUNCTION__  
#define __FUNCTION__ "MatMultAdd_SeqAIJ_Inode"
...
#undef __FUNCTION__  
#define __FUNCTION__ "Mat_AIJ_CheckInode"
...
/* ----------------------------------------------------------- */
#undef __FUNCTION__  
#define __FUNCTION__ "MatSolve_SeqAIJ_Inode"
...
#undef __FUNCTION__  
#define __FUNCTION__ "MatLUFactorNumeric_SeqAIJ_Inode"
static int MatLUFactorNumeric_SeqAIJ_Inode(Mat A,Mat *B)
{
  ...
  for ( i=0,row=0; i<node_max; i++ ) { 
    ...
    case 1:
      ...
      pj  = bj + bi[row];
      pc1 = ba + bi[row];
      if (rtmp1[row] == 0.0) {SETERRQ(1,"MatLUFactorNumeric_SeqAIJ_Inode:Zero pivot");}
    ...
    case 2:
      ...
      if (*pc2 != 0.0){
        pj   = nbj + bd[prow];
        if(*pc1 ==0.0) {SETERRQ(1,"MatLUFactorNumeric_SeqAIJ_Inode:Zero pivot");}
      ...
      pc1 = ba + bi[row];
      pc2 = ba + bi[row+1];
      if (rtmp1[row] == 0.0 || rtmp2[row+1] == 0.0) {SETERRQ(1,"MatLUFactorNumeric_SeqAIJ_Inode:Zero pivot");}
      rtmp1[row]   = 1.0/rtmp1[row];
    ...
    case 3:
      ...
      if (*pc3 != 0.0){
        pj   = nbj + bd[prow];
        if(*pc2 ==0.0) {SETERRQ(1,"MatLUFactorNumeric_SeqAIJ_Inode:Zero pivot");}
        mul3 = (*pc3)/(*pc2);
        *pc3 = mul3;
        nz   = bi[prow+1] - bd[prow] - 1;
        PLogFlops(2*2*nz);
      ...
      pc2 = ba + bi[row+1];
      pc3 = ba + bi[row+2];
      if (rtmp1[row] == 0.0 || rtmp2[row+1] == 0.0 || rtmp3[row+2]==0.0) {SETERRQ(1,"MatLUFactorNumeric_SeqAIJ_Inode:Zero pivot");}
      rtmp1[row]   = 1.0/rtmp1[row];
      rtmp2[row+1] = 1.0/rtmp2[row+1];
...
*/
#undef __FUNCTION__  
#define __FUNCTION__ "MatAdjustForInodes"
