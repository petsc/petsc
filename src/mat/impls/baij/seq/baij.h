...
PETSC_INTERN PetscErrorCode MatGetDiagonalMarkers_SeqBAIJ(Mat, const PetscInt **, PetscBool *);
...
PETSC_INTERN PetscErrorCode MatILUFactorNumeric_SeqBAIJ_1_inplace(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatLUFactorNumeric_SeqBAIJ_1(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatILUFactorNumeric_SeqBAIJ_2_inplace(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatLUFactorNumeric_SeqBAIJ_2(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatILUFactorNumeric_SeqBAIJ_2_NaturalOrdering_inplace(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatLUFactorNumeric_SeqBAIJ_2_NaturalOrdering(Mat, Mat, const MatFactorInfo *);

PETSC_INTERN PetscErrorCode MatILUFactorNumeric_SeqBAIJ_3_inplace(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatLUFactorNumeric_SeqBAIJ_3(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatILUFactorNumeric_SeqBAIJ_3_NaturalOrdering_inplace(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatLUFactorNumeric_SeqBAIJ_3_NaturalOrdering(Mat, Mat, const MatFactorInfo *);

PETSC_INTERN PetscErrorCode MatILUFactorNumeric_SeqBAIJ_4_inplace(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatLUFactorNumeric_SeqBAIJ_4(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatILUFactorNumeric_SeqBAIJ_4_NaturalOrdering_inplace(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatLUFactorNumeric_SeqBAIJ_4_NaturalOrdering(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatILUFactorNumeric_SeqBAIJ_5_inplace(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatLUFactorNumeric_SeqBAIJ_5(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatILUFactorNumeric_SeqBAIJ_5_NaturalOrdering_inplace(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatLUFactorNumeric_SeqBAIJ_5_NaturalOrdering(Mat, Mat, const MatFactorInfo *);

PETSC_INTERN PetscErrorCode MatILUFactorNumeric_SeqBAIJ_6_inplace(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatLUFactorNumeric_SeqBAIJ_6(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatILUFactorNumeric_SeqBAIJ_6_NaturalOrdering_inplace(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatLUFactorNumeric_SeqBAIJ_6_NaturalOrdering(Mat, Mat, const MatFactorInfo *);

PETSC_INTERN PetscErrorCode MatILUFactorNumeric_SeqBAIJ_7_inplace(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatLUFactorNumeric_SeqBAIJ_7(Mat, Mat, const MatFactorInfo *);
PETSC_INTERN PetscErrorCode MatILUFactorNumeric_SeqBAIJ_7_NaturalOrdering_inplace(Mat, Mat, const MatFactorInfo *);
...
PETSC_INTERN PetscErrorCode MatILUFactorNumeric_SeqBAIJ_N_inplace(Mat, Mat, const MatFactorInfo *);
...
{
  PetscCall(PetscArraycpy(W, A, 16));
...
{
  PetscCall(PetscArraycpy(W, A, 25));
...
{
  PetscCall(PetscArraycpy(W, A, 36));
...
{
  PetscCall(PetscArraycpy(W, A, 49));
...
static inline PetscErrorCode PetscKernel_A_gets_A_times_B_9(PetscScalar *A, const PetscScalar *B, PetscScalar *W)
{
  ...
  PetscCall(PetscArraycpy(W, A, 81));
  for (i = 0; i < 3; i++) {
    ...
    S5 = _mm256_setzero_pd();
    S6 = _mm256_setzero_pd();
    S7 = _mm256_setzero_pd();
    S8 = _mm256_setzero_pd();

    A0 = _mm256_loadu_pd(W + 0);
    A1 = _mm256_loadu_pd(W + 4);
    A2 = _mm256_loadu_pd(W + 8);
    B0 = _mm256_broadcast_sd(B + 0);
    B1 = _mm256_broadcast_sd(B + 9);
    B2 = _mm256_broadcast_sd(B + 18);
    S0 = _mm256_fmadd_pd(A0, B0, S0);
    S1 = _mm256_fmadd_pd(A1, B0, S1);
    S2 = _mm256_fmadd_pd(A2, B0, S2);
    S3 = _mm256_fmadd_pd(A0, B1, S3);
    S4 = _mm256_fmadd_pd(A1, B1, S4);
    S5 = _mm256_fmadd_pd(A2, B1, S5);
    S6 = _mm256_fmadd_pd(A0, B2, S6);
    S7 = _mm256_fmadd_pd(A1, B2, S7);
    S8 = _mm256_fmadd_pd(A2, B2, S8);

    A3 = _mm256_loadu_pd(W + 9);
    A4 = _mm256_loadu_pd(W + 13);
    A5 = _mm256_loadu_pd(W + 17);
    B6 = _mm256_broadcast_sd(B + 1);
    B7 = _mm256_broadcast_sd(B + 10);
    B8 = _mm256_broadcast_sd(B + 19);
    S0 = _mm256_fmadd_pd(A3, B6, S0);
    S1 = _mm256_fmadd_pd(A4, B6, S1);
    S2 = _mm256_fmadd_pd(A5, B6, S2);
    S3 = _mm256_fmadd_pd(A3, B7, S3);
    S4 = _mm256_fmadd_pd(A4, B7, S4);
    S5 = _mm256_fmadd_pd(A5, B7, S5);
    S6 = _mm256_fmadd_pd(A3, B8, S6);
    S7 = _mm256_fmadd_pd(A4, B8, S7);
    S8 = _mm256_fmadd_pd(A5, B8, S8);

    A6 = _mm256_loadu_pd(W + 18);
    A7 = _mm256_loadu_pd(W + 22);
    A8 = _mm256_loadu_pd(W + 26);
    B0 = _mm256_broadcast_sd(B + 2);
    B1 = _mm256_broadcast_sd(B + 11);
    B2 = _mm256_broadcast_sd(B + 20);
    S0 = _mm256_fmadd_pd(A6, B0, S0);
    S1 = _mm256_fmadd_pd(A7, B0, S1);
    S2 = _mm256_fmadd_pd(A8, B0, S2);
    S3 = _mm256_fmadd_pd(A6, B1, S3);
    S4 = _mm256_fmadd_pd(A7, B1, S4);
    S5 = _mm256_fmadd_pd(A8, B1, S5);
    S6 = _mm256_fmadd_pd(A6, B2, S6);
    S7 = _mm256_fmadd_pd(A7, B2, S7);
    S8 = _mm256_fmadd_pd(A8, B2, S8);

    A0 = _mm256_loadu_pd(W + 27);
    A1 = _mm256_loadu_pd(W + 31);
    A2 = _mm256_loadu_pd(W + 35);
    B6 = _mm256_broadcast_sd(B + 3);
    B7 = _mm256_broadcast_sd(B + 12);
    B8 = _mm256_broadcast_sd(B + 21);
    S0 = _mm256_fmadd_pd(A0, B6, S0);
    S1 = _mm256_fmadd_pd(A1, B6, S1);
    S2 = _mm256_fmadd_pd(A2, B6, S2);
    S3 = _mm256_fmadd_pd(A0, B7, S3);
    S4 = _mm256_fmadd_pd(A1, B7, S4);
    S5 = _mm256_fmadd_pd(A2, B7, S5);
    S6 = _mm256_fmadd_pd(A0, B8, S6);
    S7 = _mm256_fmadd_pd(A1, B8, S7);
    S8 = _mm256_fmadd_pd(A2, B8, S8);

    A3 = _mm256_loadu_pd(W + 36);
    A4 = _mm256_loadu_pd(W + 40);
    A5 = _mm256_loadu_pd(W + 44);
    B0 = _mm256_broadcast_sd(B + 4);
    B1 = _mm256_broadcast_sd(B + 13);
    B2 = _mm256_broadcast_sd(B + 22);
    S0 = _mm256_fmadd_pd(A3, B0, S0);
    S1 = _mm256_fmadd_pd(A4, B0, S1);
    S2 = _mm256_fmadd_pd(A5, B0, S2);
    S3 = _mm256_fmadd_pd(A3, B1, S3);
    S4 = _mm256_fmadd_pd(A4, B1, S4);
    S5 = _mm256_fmadd_pd(A5, B1, S5);
    S6 = _mm256_fmadd_pd(A3, B2, S6);
    S7 = _mm256_fmadd_pd(A4, B2, S7);
    S8 = _mm256_fmadd_pd(A5, B2, S8);

    A0 = _mm256_loadu_pd(W + 45);
    A1 = _mm256_loadu_pd(W + 49);
    A2 = _mm256_loadu_pd(W + 53);
    B6 = _mm256_broadcast_sd(B + 5);
    B7 = _mm256_broadcast_sd(B + 14);
    B8 = _mm256_broadcast_sd(B + 23);
    S0 = _mm256_fmadd_pd(A0, B6, S0);
    S1 = _mm256_fmadd_pd(A1, B6, S1);
    S2 = _mm256_fmadd_pd(A2, B6, S2);
    S3 = _mm256_fmadd_pd(A0, B7, S3);
    ...
    A3 = _mm256_loadu_pd(W + 54);
    A4 = _mm256_loadu_pd(W + 58);
    A5 = _mm256_loadu_pd(W + 62);
    B0 = _mm256_broadcast_sd(B + 6);
    B1 = _mm256_broadcast_sd(B + 15);
    B2 = _mm256_broadcast_sd(B + 24);
    S0 = _mm256_fmadd_pd(A3, B0, S0);
    S1 = _mm256_fmadd_pd(A4, B0, S1);
    S2 = _mm256_fmadd_pd(A5, B0, S2);
    S3 = _mm256_fmadd_pd(A3, B1, S3);
    ...
    A6 = _mm256_loadu_pd(W + 63);
    A7 = _mm256_loadu_pd(W + 67);
    A8 = _mm256_loadu_pd(W + 71);
    B6 = _mm256_broadcast_sd(B + 7);
    B7 = _mm256_broadcast_sd(B + 16);
    B8 = _mm256_broadcast_sd(B + 25);
    S0 = _mm256_fmadd_pd(A6, B6, S0);
    S1 = _mm256_fmadd_pd(A7, B6, S1);
    S2 = _mm256_fmadd_pd(A8, B6, S2);
    S3 = _mm256_fmadd_pd(A6, B7, S3);
    S4 = _mm256_fmadd_pd(A7, B7, S4);
    S5 = _mm256_fmadd_pd(A8, B7, S5);
    S6 = _mm256_fmadd_pd(A6, B8, S6);
    S7 = _mm256_fmadd_pd(A7, B8, S7);
    S8 = _mm256_fmadd_pd(A8, B8, S8);

    A0 = _mm256_loadu_pd(W + 72);
    A1 = _mm256_loadu_pd(W + 76);
    A2 = _mm256_broadcast_sd(W + 80);
    B0 = _mm256_broadcast_sd(B + 8);
    B1 = _mm256_broadcast_sd(B + 17);
    B2 = _mm256_broadcast_sd(B + 26);
    S0 = _mm256_fmadd_pd(A0, B0, S0);
    S1 = _mm256_fmadd_pd(A1, B0, S1);
    S2 = _mm256_fmadd_pd(A2, B0, S2);
    S3 = _mm256_fmadd_pd(A0, B1, S3);
    ...
    _mm256_storeu_pd(&A[0 + i * 27], S0);
    _mm256_storeu_pd(&A[4 + i * 27], S1);
    _mm256_maskstore_pd(&A[8 + i * 27], _mm256_set_epi64x(0LL, 0LL, 0LL, 1LL << 63), S2);
    _mm256_storeu_pd(&A[9 + i * 27], S3);
    _mm256_storeu_pd(&A[13 + i * 27], S4);
    _mm256_maskstore_pd(&A[17 + i * 27], _mm256_set_epi64x(0LL, 0LL, 0LL, 1LL << 63), S5);
    _mm256_storeu_pd(&A[18 + i * 27], S6);
    _mm256_storeu_pd(&A[22 + i * 27], S7);
    _mm256_maskstore_pd(&A[26 + i * 27], _mm256_set_epi64x(0LL, 0LL, 0LL, 1LL << 63), S8);
...
static inline PetscErrorCode PetscKernel_A_gets_A_minus_B_times_C_9(PetscScalar *A, const PetscScalar *B, const PetscScalar *C)
{
  ...
  for (i = 0; i < 3; i++) {
    A0 = _mm256_loadu_pd(A + 0);
    A1 = _mm256_loadu_pd(A + 4);
    A2 = _mm256_loadu_pd(A + 8);
    A3 = _mm256_loadu_pd(A + 9);
    A4 = _mm256_loadu_pd(A + 13);
    A5 = _mm256_loadu_pd(A + 17);
    A6 = _mm256_loadu_pd(A + 18);
    A7 = _mm256_loadu_pd(A + 22);
    A8 = _mm256_loadu_pd(A + 26);

    B0 = _mm256_loadu_pd(B + 0);
    B1 = _mm256_loadu_pd(B + 4);
    B2 = _mm256_loadu_pd(B + 8);
    C0 = _mm256_broadcast_sd(C + 0);
    C1 = _mm256_broadcast_sd(C + 9);
    C2 = _mm256_broadcast_sd(C + 18);
    A0 = _mm256_fnmadd_pd(B0, C0, A0);
    A1 = _mm256_fnmadd_pd(B1, C0, A1);
    A2 = _mm256_fnmadd_pd(B2, C0, A2);
    A3 = _mm256_fnmadd_pd(B0, C1, A3);
    A4 = _mm256_fnmadd_pd(B1, C1, A4);
    A5 = _mm256_fnmadd_pd(B2, C1, A5);
    A6 = _mm256_fnmadd_pd(B0, C2, A6);
    A7 = _mm256_fnmadd_pd(B1, C2, A7);
    A8 = _mm256_fnmadd_pd(B2, C2, A8);

    B3 = _mm256_loadu_pd(B + 9);
    B4 = _mm256_loadu_pd(B + 13);
    B5 = _mm256_loadu_pd(B + 17);
    C3 = _mm256_broadcast_sd(C + 1);
    C4 = _mm256_broadcast_sd(C + 10);
    C5 = _mm256_broadcast_sd(C + 19);
    A0 = _mm256_fnmadd_pd(B3, C3, A0);
    A1 = _mm256_fnmadd_pd(B4, C3, A1);
    A2 = _mm256_fnmadd_pd(B5, C3, A2);
    A3 = _mm256_fnmadd_pd(B3, C4, A3);
    A4 = _mm256_fnmadd_pd(B4, C4, A4);
    A5 = _mm256_fnmadd_pd(B5, C4, A5);
    A6 = _mm256_fnmadd_pd(B3, C5, A6);
    A7 = _mm256_fnmadd_pd(B4, C5, A7);
    A8 = _mm256_fnmadd_pd(B5, C5, A8);

    B6 = _mm256_loadu_pd(B + 18);
    B7 = _mm256_loadu_pd(B + 22);
    B8 = _mm256_loadu_pd(B + 26);
    C6 = _mm256_broadcast_sd(C + 2);
    C7 = _mm256_broadcast_sd(C + 11);
    C8 = _mm256_broadcast_sd(C + 20);
    A0 = _mm256_fnmadd_pd(B6, C6, A0);
    A1 = _mm256_fnmadd_pd(B7, C6, A1);
    A2 = _mm256_fnmadd_pd(B8, C6, A2);
    A3 = _mm256_fnmadd_pd(B6, C7, A3);
    A4 = _mm256_fnmadd_pd(B7, C7, A4);
    A5 = _mm256_fnmadd_pd(B8, C7, A5);
    A6 = _mm256_fnmadd_pd(B6, C8, A6);
    A7 = _mm256_fnmadd_pd(B7, C8, A7);
    A8 = _mm256_fnmadd_pd(B8, C8, A8);

    B0 = _mm256_loadu_pd(B + 27);
    B1 = _mm256_loadu_pd(B + 31);
    B2 = _mm256_loadu_pd(B + 35);
    C0 = _mm256_broadcast_sd(C + 3);
    C1 = _mm256_broadcast_sd(C + 12);
    C2 = _mm256_broadcast_sd(C + 21);
    A0 = _mm256_fnmadd_pd(B0, C0, A0);
    A1 = _mm256_fnmadd_pd(B1, C0, A1);
    A2 = _mm256_fnmadd_pd(B2, C0, A2);
    A3 = _mm256_fnmadd_pd(B0, C1, A3);
    ...
    B3 = _mm256_loadu_pd(B + 36);
    B4 = _mm256_loadu_pd(B + 40);
    B5 = _mm256_loadu_pd(B + 44);
    C3 = _mm256_broadcast_sd(C + 4);
    C4 = _mm256_broadcast_sd(C + 13);
    C5 = _mm256_broadcast_sd(C + 22);
    A0 = _mm256_fnmadd_pd(B3, C3, A0);
    A1 = _mm256_fnmadd_pd(B4, C3, A1);
    A2 = _mm256_fnmadd_pd(B5, C3, A2);
    A3 = _mm256_fnmadd_pd(B3, C4, A3);
    ...
    B6 = _mm256_loadu_pd(B + 45);
    B7 = _mm256_loadu_pd(B + 49);
    B8 = _mm256_loadu_pd(B + 53);
    C6 = _mm256_broadcast_sd(C + 5);
    C7 = _mm256_broadcast_sd(C + 14);
    C8 = _mm256_broadcast_sd(C + 23);
    A0 = _mm256_fnmadd_pd(B6, C6, A0);
    A1 = _mm256_fnmadd_pd(B7, C6, A1);
    A2 = _mm256_fnmadd_pd(B8, C6, A2);
    A3 = _mm256_fnmadd_pd(B6, C7, A3);
    ...
    B0 = _mm256_loadu_pd(B + 54);
    B1 = _mm256_loadu_pd(B + 58);
    B2 = _mm256_loadu_pd(B + 62);
    C0 = _mm256_broadcast_sd(C + 6);
    C1 = _mm256_broadcast_sd(C + 15);
    C2 = _mm256_broadcast_sd(C + 24);
    A0 = _mm256_fnmadd_pd(B0, C0, A0);
    A1 = _mm256_fnmadd_pd(B1, C0, A1);
    A2 = _mm256_fnmadd_pd(B2, C0, A2);
    A3 = _mm256_fnmadd_pd(B0, C1, A3);
    ...
    B3 = _mm256_loadu_pd(B + 63);
    B4 = _mm256_loadu_pd(B + 67);
    B5 = _mm256_loadu_pd(B + 71);
    C3 = _mm256_broadcast_sd(C + 7);
    C4 = _mm256_broadcast_sd(C + 16);
    C5 = _mm256_broadcast_sd(C + 25);
    A0 = _mm256_fnmadd_pd(B3, C3, A0);
    A1 = _mm256_fnmadd_pd(B4, C3, A1);
    A2 = _mm256_fnmadd_pd(B5, C3, A2);
    A3 = _mm256_fnmadd_pd(B3, C4, A3);
    ...
    B6 = _mm256_loadu_pd(B + 72);
    B7 = _mm256_loadu_pd(B + 76);
    B8 = _mm256_broadcast_sd(B + 80);
    C6 = _mm256_broadcast_sd(C + 8);
    C7 = _mm256_broadcast_sd(C + 17);
    C8 = _mm256_broadcast_sd(C + 26);
    A0 = _mm256_fnmadd_pd(B6, C6, A0);
    A1 = _mm256_fnmadd_pd(B7, C6, A1);
    A2 = _mm256_fnmadd_pd(B8, C6, A2);
    A3 = _mm256_fnmadd_pd(B6, C7, A3);
    ...
    _mm256_storeu_pd(&A[4], A1);
    _mm256_maskstore_pd(&A[8], _mm256_set_epi64x(0LL, 0LL, 0LL, 1LL << 63), A2);
    _mm256_storeu_pd(&A[9], A3);
    _mm256_storeu_pd(&A[13], A4);
    _mm256_maskstore_pd(&A[17], _mm256_set_epi64x(0LL, 0LL, 0LL, 1LL << 63), A5);
    _mm256_storeu_pd(&A[18], A6);
    _mm256_storeu_pd(&A[22], A7);
    _mm256_maskstore_pd(&A[26], _mm256_set_epi64x(0LL, 0LL, 0LL, 1LL << 63), A8);
...
{
  PetscCall(PetscArraycpy(W, A, 121));
...
{
  PetscCall(PetscArraycpy(W, A, 225));
