...
PETSC_EXTERN_C PetscErrorCode  MatConvert_SeqBAIJ_SeqBSTRM(Mat A,MatType type,MatReuse reuse,Mat *newmat)
{
  PetscErrorCode ierr;
  Mat            B = *newmat;
  Mat_SeqBSTRM   *bstrm;
...
PETSC_EXTERN_C PetscErrorCode MatCreate_SeqBSTRM(Mat A)
{
  PetscErrorCode ierr;
