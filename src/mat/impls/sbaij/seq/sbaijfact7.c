...
PetscErrorCode MatCholeskyFactorNumeric_SeqSBAIJ_5(Mat C,Mat A,MatFactorInfo *info)
{
  ...
  C->ops->solve          = MatSolve_SeqSBAIJ_5;
  C->ops->solvetranspose = MatSolve_SeqSBAIJ_5;
