...
PetscErrorCode MatCholeskyFactorNumeric_SeqSBAIJ_4(Mat A,MatFactorInfo *info,Mat *B)
{
  Mat            C = *B;
  ...
  C->ops->solve          = MatSolve_SeqSBAIJ_4;
  C->ops->solvetranspose = MatSolve_SeqSBAIJ_4;
