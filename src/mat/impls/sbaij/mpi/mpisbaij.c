...
{ 
  ...
  */
  ...
  /* b->compressedrow.use = PETSC_TRUE; -- cannot be used on baij->B without customization,
        because MatMult_MPISBAIJ uses very different algorithm than MatMult_MPIBAIJ() */
