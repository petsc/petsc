...
PETSC_INTERN PetscErrorCode MatMatMult_SeqSBAIJ_SeqDense(Mat,Mat,MatReuse,PetscReal,Mat*);
PETSC_INTERN PetscErrorCode MatMatMult_Nest_Dense(Mat,Mat,MatReuse,PetscReal,Mat*);
