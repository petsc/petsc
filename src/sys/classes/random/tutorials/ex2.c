...
int main(int argc, char *argv[])
{
  ...
  if (hinfo.n <1 || hinfo.n > 31) SETERRQ(PETSC_COMM_SELF,PETSC_ERR_SUP,"Only 31 stocks listed in stock.txt. num_of_stocks %" PetscInt_FMT " must between 1 and 31",hinfo.n);
