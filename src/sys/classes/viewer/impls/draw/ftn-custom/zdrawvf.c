...
PETSC_EXTERN void petscviewermonitorlgsetup_(PetscViewer *viewer, char *host, char *title, char *metric, int l, const char **names, int *x, int *y, int *m, int *n, PetscErrorCode *ierr, PETSC_FORTRAN_CHARLEN_T len1, PETSC_FORTRAN_CHARLEN_T len2, PETSC_FORTRAN_CHARLEN_T len3)
{
  char *t1, *t2, *t3;
  ...
  *ierr = PetscViewerMonitorLGSetUp(*viewer, t1, t2, t3, l, names, *x, *y, *m, *n);
}
