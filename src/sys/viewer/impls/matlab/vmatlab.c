...
PetscErrorCode PETSC_DLLEXPORT PetscViewerMatlabPutArray(PetscViewer mfile,int m,int n,PetscScalar *array,char *name)
{
  ...
  PetscFunctionBegin;  
  if (!ml->rank) {
    ierr = PetscVerboseInfo((0,"PetscViewerMatlabPutArray:Putting Matlab array %s\n",name));CHKERRQ(ierr);
    ...
    ierr = PetscVerboseInfo((0,"PetscViewerMatlabPutArray:Put Matlab array %s\n",name));CHKERRQ(ierr);
  }
...
PetscErrorCode PETSC_DLLEXPORT PetscViewerMatlabGetArray(PetscViewer mfile,int m,int n,PetscScalar *array,char *name)
{
  ...
  PetscFunctionBegin;  
  if (!ml->rank) {
    ierr = PetscVerboseInfo((0,"PetscViewerMatlabGetArray:Getting Matlab array %s\n",name));CHKERRQ(ierr);
    ...
    ierr = PetscVerboseInfo((0,"PetscViewerMatlabGetArray:Got Matlab array %s\n",name));CHKERRQ(ierr);
  }
  PetscFunctionReturn(0);
}
