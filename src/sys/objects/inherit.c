...
PetscErrorCode PetscHeaderCreate_Function(PetscErrorCode ierr, PetscObject *h, PetscClassId classid, const char class_name[], const char descr[], const char mansec[], MPI_Comm comm, PetscObjectDestroy_Fn *destroy, PetscObjectView_Fn *view)
{
  if (ierr) return ierr;
  PetscFunctionBegin;
...
*/
PetscErrorCode PetscHeaderCreate_Private(PetscObject h, PetscClassId classid, const char class_name[], const char descr[], const char mansec[], MPI_Comm comm, PetscObjectDestroy_Fn *destroy, PetscObjectView_Fn *view)
{
  void       *get_tmp;
  PetscInt64 *cidx;
  PetscMPIInt flg;
