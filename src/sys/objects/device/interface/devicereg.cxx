...
PetscErrorCode PetscDeviceInitializePackage(void)
{
  ...
  if (PetscUnlikely(!PetscDeviceConfiguredFor_Internal(PETSC_DEVICE_DEFAULT))) SETERRQ(PETSC_COMM_SELF,PETSC_ERR_SUP,"PETSc is not configured with device support (PETSC_DEVICE_DEFAULT = '%s')",PetscDeviceTypes[PETSC_DEVICE_DEFAULT]);
