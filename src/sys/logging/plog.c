...
#undef __FUNCT__
#define __FUNCT__ "PetscLogView_Python"
/*
   PetscLogView_Python - Saves logging information in a Python format.
...
*/
PetscErrorCode  PetscLogView_Python(PetscViewer viewer)
{
  FILE               *fd;
