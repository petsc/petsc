...
PetscErrorCode PETSC_DLLEXPORT PetscMatlabEngineCreate(MPI_Comm comm,const char machine[],PetscMatlabEngine *mengine)
{
  ...
  ierr = PetscVerboseInfo((0,"PetscMatlabEngineCreate:Starting Matlab engine on %s\n",machine));CHKERRQ(ierr);
  ...
  ierr = PetscVerboseInfo((0,"PetscMatlabEngineCreate:Started Matlab engine on %s\n",machine));CHKERRQ(ierr);
...
PetscErrorCode PETSC_DLLEXPORT PetscMatlabEngineEvaluate(PetscMatlabEngine mengine,const char string[],...)
{
  ...
  ierr = PetscVerboseInfo((0,"PetscMatlabEngineEvaluate:Evaluating Matlab string: %s\n",buffer));CHKERRQ(ierr);
  ...
  */
  ...
  ierr = PetscVerboseInfo((0,"PetscMatlabEngineEvaluate:Done evaluating Matlab string: %s\n",buffer));CHKERRQ(ierr);
  PetscFunctionReturn(0);
}
...
PetscErrorCode PETSC_DLLEXPORT PetscMatlabEnginePut(PetscMatlabEngine mengine,PetscObject obj)
{
  ...
  ierr = PetscVerboseInfo((0,"PetscMatlabEnginePut:Putting Matlab object\n"));CHKERRQ(ierr);
  ierr = (*put)(obj,mengine->ep);CHKERRQ(ierr);
  ierr = PetscVerboseInfo((0,"PetscMatlabEnginePut:Put Matlab object: %s\n",obj->name));CHKERRQ(ierr);
  PetscFunctionReturn(0);
}
...
PetscErrorCode PETSC_DLLEXPORT PetscMatlabEngineGet(PetscMatlabEngine mengine,PetscObject obj)
{
  ...
  ierr = PetscVerboseInfo((0,"PetscMatlabEngineGet:Getting Matlab object\n"));CHKERRQ(ierr);
  ierr = (*get)(obj,mengine->ep);CHKERRQ(ierr);
  ierr = PetscVerboseInfo((0,"PetscMatlabEngineGet:Got Matlab object: %s\n",obj->name));CHKERRQ(ierr);
  PetscFunctionReturn(0);
}
...
PetscErrorCode PETSC_DLLEXPORT PetscMatlabEnginePutArray(PetscMatlabEngine mengine,int m,int n,PetscScalar *array,const char name[])
{
  ...
  PetscFunctionBegin;  
  ierr = PetscVerboseInfo((0,"PetscMatlabEnginePutArray:Putting Matlab array %s\n",name));CHKERRQ(ierr);
  ...
  ierr = PetscVerboseInfo((0,"PetscMatlabEnginePutArray:Put Matlab array %s\n",name));CHKERRQ(ierr);
  PetscFunctionReturn(0);
}
...
PetscErrorCode PETSC_DLLEXPORT PetscMatlabEngineGetArray(PetscMatlabEngine mengine,int m,int n,PetscScalar *array,const char name[])
{
  ...
  PetscFunctionBegin;  
  ierr = PetscVerboseInfo((0,"PetscMatlabEngineGetArray:Getting Matlab array %s\n",name));CHKERRQ(ierr);
  ...
  ierr = PetscVerboseInfo((0,"PetscMatlabEngineGetArray:Got Matlab array %s\n",name));CHKERRQ(ierr);
  PetscFunctionReturn(0);
}
