/*
  macro expansion:
  function_driver -> adintr_sinh
  exception number -> ADINTR_SINH
  exceptional code -> 
...
void
adintr_sinh (int deriv_order, int file_number, int line_number,
		 double*fx,...)
{
     ...
     const int exception = ADINTR_SINH;
     ...
     *fxx = ADIntr_Partials[ADINTR_SINH][ADINTR_FXX];
