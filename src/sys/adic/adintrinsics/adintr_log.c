/*
  macro expansion:
  function_driver -> adintr_log
  exception number -> ADINTR_LOG
  exceptional code -> 
...
void
adintr_log (int deriv_order, int file_number, int line_number,
		 double*fx,...)
{
     ...
     const int exception = ADINTR_LOG;
     ...
     *fx = ADIntr_Partials[ADINTR_LOG][ADINTR_FX];
     *fxx = ADIntr_Partials[ADINTR_LOG][ADINTR_FXX];
