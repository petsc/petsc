/*
  macro expansion:
  function_driver -> adintr_tanh
  exception number -> ADINTR_TANH
  exceptional code -> 
...
void
adintr_tanh (int deriv_order, int file_number, int line_number,
		 double*fx,...)
{
     ...
     const int exception = ADINTR_TANH;
     ...
     *fx = ADIntr_Partials[ADINTR_TANH][ADINTR_FX];
     *fxx = ADIntr_Partials[ADINTR_TANH][ADINTR_FXX];
