...
%  IBM SP2, Cray T3E and Origin2000 in that order.
%
m100 = [ 1.602 1.116 .793 .638 .5297 .4633 .4181 .5808; 2.233 1.434 1.064 .8116 .6748 .6095 \
         .5338 .4873];
s100 = [ 9.425 6.036 4.32 3.334 3.634 3.656 3.657 4.248; 9.566 5.704 4.260 3.080 3.000 2.696
         2.614 2.6061];
%
