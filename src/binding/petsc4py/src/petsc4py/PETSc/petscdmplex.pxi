...
cdef extern from * nogil:
    ...
    PetscErrorCode DMPlexTransformGetSourcePoint(PetscDMPlexTransform, PetscInt, PetscDMPolytopeType *, PetscDMPolytopeType *, PetscInt *, PetscInt *)
    PetscErrorCode DMPlexTransformGetTargetPoint(PetscDMPlexTransform, PetscDMPolytopeType, PetscDMPolytopeType, PetscInt, PetscInt, PetscInt *)
    PetscErrorCode DMPlexTransformGetActive(PetscDMPlexTransform, PetscDMLabel *)
    PetscErrorCode DMPlexTransformSetActive(PetscDMPlexTransform, PetscDMLabel)
    PetscErrorCode DMPlexTransformCreateSplitCellLabel(PetscDMPlexTransform, PetscDM, PetscDMLabel *)
    PetscErrorCode DMPlexSetSaveTransform(PetscDM, PetscBool)
    PetscErrorCode DMPlexGetSaveTransform(PetscDM, PetscBool *)
    PetscErrorCode DMPlexGetTransform(PetscDM, PetscDMPlexTransform *)
    PetscErrorCode DMPlexSetTransform(PetscDM, PetscDMPlexTransform)
