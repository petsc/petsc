...
class BaseTestSNES:
    ...
    def testSetGetStepFails(self):
        ...
        fails = self.snes.getStepFailures()
        self.assertEqual(fails, 0)
        fails = self.snes.getMaxStepFailures()
        self.assertEqual(fails, 1)
        self.snes.setMaxStepFailures(5)
        fails = self.snes.getMaxStepFailures()
        self.assertEqual(fails, 5)
        self.snes.setMaxStepFailures(1)
        fails = self.snes.getMaxStepFailures()
        self.assertEqual(fails, 1)
    ...
    def testSetGetLinFails(self):
        ...
        self.assertEqual(its, 0)
        fails = self.snes.getKSPFailures()
        self.assertEqual(fails, 0)
        fails = self.snes.getMaxKSPFailures()
        self.assertEqual(fails, 1)
        self.snes.setMaxKSPFailures(5)
        fails = self.snes.getMaxKSPFailures()
        self.assertEqual(fails, 5)
        self.snes.setMaxKSPFailures(1)
        fails = self.snes.getMaxKSPFailures()
        self.assertEqual(fails, 1)
