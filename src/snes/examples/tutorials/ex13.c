...
/*TEST
  ...
  test:
    suffix: 2d_p1_0
    requires: triangle
    args: -potential_petscspace_order 1 -dm_refine 3 -num_refine 2 -snes_convergence_estimate
  test:
  ...
  test:
    suffix: 2d_p2_0
    requires: triangle
    args: -potential_petscspace_order 2 -dm_refine 3 -num_refine 2 -snes_convergence_estimate
  test:
    suffix: 2d_p3_0
    requires: triangle
    args: -potential_petscspace_order 3 -dm_refine 3 -num_refine 2 -snes_convergence_estimate
  test:
    suffix: 2d_q1_0
    args: -simplex 0 -potential_petscspace_order 1 -dm_refine 3 -num_refine 2 -snes_convergence_estimate
  test:
    suffix: 2d_q2_0
    args: -simplex 0 -potential_petscspace_order 2 -dm_refine 3 -num_refine 2 -snes_convergence_estimate
  test:
    suffix: 2d_q3_0
    args: -simplex 0 -potential_petscspace_order 3 -dm_refine 3 -num_refine 2 -snes_convergence_estimate
  test:
    suffix: 3d_p1_0
    requires: ctetgen
    args: -dim 3 -potential_petscspace_order 1 -dm_refine 2 -num_refine 1 -snes_convergence_estimate
  test:
    suffix: 3d_p2_0
    requires: ctetgen
    args: -dim 3 -potential_petscspace_order 2 -dm_refine 2 -num_refine 1 -snes_convergence_estimate
  test:
    suffix: 3d_p3_0
    requires: ctetgen
    timeoutfactor: 2
    args: -dim 3 -potential_petscspace_order 3 -dm_refine 2 -num_refine 1 -snes_convergence_estimate
  test:
    suffix: 3d_q1_0
    args: -dim 3 -simplex 0 -potential_petscspace_order 1 -dm_refine 2 -num_refine 1 -snes_convergence_estimate
  test:
    suffix: 3d_q2_0
    args: -dim 3 -simplex 0 -potential_petscspace_order 2 -dm_refine 2 -num_refine 1 -snes_convergence_estimate
  test:
    suffix: 3d_q3_0
    args: -dim 3 -simplex 0 -potential_petscspace_order 3 -dm_refine 1 -num_refine 1 -snes_convergence_estimate
  test:
