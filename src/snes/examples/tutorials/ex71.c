...
/* The same as ex70.c, but using a symmetric formulation, leading to the       */
/* block structure                                                             */
/* (A00 A01)                                                                   */
/* (A01' 0 )                                                                   */
/*                                                                             */
...
/* Usage:                                                                      */
/*                                                                             */
/* mpiexec -n 2 ./ex71 -nx 4 -ny 8 -ksp_type fgmres -pc_type fieldsplit -pc_fieldsplit_type gkb -fieldsplit_0_ksp_type cg -fieldsplit_0_pc_type jacobi -fieldsplit_0_ksp_rtol 1e-10 */
/*                                                                             */
/*   Runs with PCFIELDSPLIT on 4x8 grid. We use the Golub-Kahan              */
/*   bidiagonalization method as preconditioner for FGMRES.                    */
/*   The inner solver is a CG method.                                          */
/*   PCFIELDSPLIT is a variable preconditioner.                                */
/*                                                                             */
/* mpiexec -n 2 ./ex71 -nx 4 -ny 8 -ksp_type preonly -pc_type fieldsplit -pc_fieldsplit_type gkb -fieldsplit_0_ksp_type cg -fieldsplit_0_pc_type jacobi -fieldsplit_0_ksp_rtol 1e-10 */
/*                                                                             */
/*   Runs with PCFIELDSPLIT on 4x8 grid, but using the Golub-Kahan method    */
/*   as solver.                                                                */
/*                                                                             */
/* mpiexec -n 2 ./ex71 -nx 4 -ny 8 -ksp_type preonly -pc_type fieldsplit -pc_fieldsplit_type gkb -pc_fieldsplit_gkb_tol 1e-4 -pc_fieldsplit_gkb_nu 5 -fieldsplit_0_ksp_type cg -fieldsplit_0_pc_type jacobi -fieldsplit_0_ksp_rtol 1e-6 */
/*                                                                             */
/*   Runs with PCFIELDSPLIT on 32x48 grid, but using the Golub-Kahan method    */
/*   as solver. The tolerance of the GKB method is set to 1e-4 and the shift   */
/*   parameter to nu = 5.                                                      */
/*                                                                             */
/*                                                                             */
/*---------------------------------------------------------------------------- */
...
int main(int argc, char **argv)
{
  ...
  /* The options for the GKB method can also be set here */
  /*  PC             prec;                               */
  /*  KSPGetPC(ksp,&prec);                               */
  /*  PCFieldSplitSetGKBNu(prec,10);                     */
  /*  PCFieldSplitSetGKBTol(prec,1e-7);                  */
  /*  PCFieldSplitSetGKBMaxit(prec,20);                  */
  /*  PCFieldSplitSetGKBDelay(prec,10);                  */
...
/*TEST
   ...
   test:
      nsize: 2
      args: -nx 4 -ny 8 -ksp_type fgmres -pc_type fieldsplit -pc_fieldsplit_type gkb -fieldsplit_0_ksp_type cg -fieldsplit_0_pc_type jacobi -fieldsplit_0_ksp_rtol 1e-10

   test:
      suffix: 2
      nsize: 2
      args: -nx 4 -ny 8 -ksp_type preonly -pc_type fieldsplit -pc_fieldsplit_type gkb -fieldsplit_0_ksp_type cg -fieldsplit_0_pc_type jacobi -fieldsplit_0_ksp_rtol 1e-10

   test:
      suffix: 3
      nsize: 2
      args: -nx 4 -ny 8 -ksp_type preonly -pc_type fieldsplit -pc_fieldsplit_type gkb -pc_fieldsplit_gkb_tol 1e-4 -pc_fieldsplit_gkb_nu 5 -fieldsplit_0_ksp_type cg -fieldsplit_0_pc_type jacobi -fieldsplit_0_ksp_rtol 1e-6
