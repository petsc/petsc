  ...
  for(k=0;k < Mda*Nda*2;k++) {
    ...
    for(r=0;r<3;r++) {
      ...
      if (k%2 == 0)  {
        ...
        row = 5*idx[r];
        cols[0] = 5*idx[0];     vals[0] = -1.0*dt*eM_2_odd[r][0]*cv_sum;
        cols[1] = 5*idx[1];     vals[1] = -1.0*dt*eM_2_odd[r][1]*cv_sum; 
        cols[2] = 5*idx[2];     vals[2] = -1.0*dt*eM_2_odd[r][2]*cv_sum;
        cols[3] = 5*idx[0]+1;   vals[3] = -1.0*eM_0[r][0];
        cols[4] = 5*idx[1]+1;   vals[4] = -1.0*eM_0[r][1];
        cols[5] = 5*idx[2]+1;   vals[5] = -1.0*eM_0[r][2];
        ...
        row = 5*idx[r]+2;
        cols[0] = 5*idx[0]+2;   vals[0] =  -1.0*dt*eM_2_odd[r][0]*ci_sum;
        cols[1] = 5*idx[1]+2;   vals[1] =  -1.0*dt*eM_2_odd[r][1]*ci_sum;
        cols[2] = 5*idx[2]+2;   vals[2] =  -1.0*dt*eM_2_odd[r][2]*ci_sum;
        cols[3] = 5*idx[0]+3;   vals[3] =  -1.0*eM_0[r][0];
        cols[4] = 5*idx[1]+3;   vals[4] =  -1.0*eM_0[r][1];
        cols[5] = 5*idx[2]+3;   vals[5] =  -1.0*eM_0[r][2];
        ...
        row = 5*idx[r];
        cols[0] = 5*idx[0];     vals[0] = -1.0*dt*eM_2_even[r][0]*cv_sum;
        cols[1] = 5*idx[1];     vals[1] = -1.0*dt*eM_2_even[r][1]*cv_sum; 
        cols[2] = 5*idx[2];     vals[2] = -1.0*dt*eM_2_even[r][2]*cv_sum;
        cols[3] = 5*idx[0]+1;   vals[3] = -1.0*eM_0[r][0];
        cols[4] = 5*idx[1]+1;   vals[4] = -1.0*eM_0[r][1];
        cols[5] = 5*idx[2]+1;   vals[5] = -1.0*eM_0[r][2];
        ...
        row = 5*idx[r]+2;
        cols[0] = 5*idx[0]+2;   vals[0] = -1.0*dt*eM_2_even[r][0]*ci_sum;
        cols[1] = 5*idx[1]+2;   vals[1] = -1.0*dt*eM_2_even[r][1]*ci_sum;
        cols[2] = 5*idx[2]+2;   vals[2] = -1.0*dt*eM_2_even[r][2]*ci_sum;
        cols[3] = 5*idx[0]+3;   vals[3] = -1.0*eM_0[r][0];
        cols[4] = 5*idx[1]+3;   vals[4] = -1.0*eM_0[r][1];
        cols[5] = 5*idx[2]+3;   vals[5] = -1.0*eM_0[r][2];
