...
/*TEST
   ...
   test:
      suffix: 5
      nsize: 6
      args: -M 12 -P 5 -snes_monitor -ksp_converged_reason -pc_type asm -pc_asm_type restrict -dm_mat_type {{aij baij sbaij}}
