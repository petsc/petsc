...
/*TEST
   ...
   test:
      ...
      nsize: 4
      requires: superlu_dist superlu_dist_version_ge(9,0,0) !defined(PETSCTEST_VALGRIND)
   ...
   test:
      ...
      nsize: 4
      requires: superlu_dist superlu_dist_version_ge(9,0,0) !defined(PETSCTEST_VALGRIND) defined(PETSC_HAVE_SUPERLU_DIST_SINGLE)
      filter: grep -v iam | grep -v openMP | sed -e "s/Column permutation MMD_AT_PLUS_A/Column permutation METIS_AT_PLUS_A/g"
