...
.seealso: [](ch_snes), `SNES`, `SNESRegisterDestroy()`
@*/
PetscErrorCode SNESRegisterAll(void)
{
  ...
  PetscCall(SNESRegister(SNESNEWTONAL, SNESCreate_NEWTONAL));
