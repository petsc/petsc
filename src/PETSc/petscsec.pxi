...
cdef extern from * nogil:
    ...
    int PetscSectionGetFieldName(PetscSection,PetscInt,const_char*[])
    int PetscSectionSetFieldName(PetscSection,PetscInt,const_char[])
    ...
    int PetscSectionGetConstraintIndices(PetscSection,PetscInt,const_PetscInt**)
    int PetscSectionSetConstraintIndices(PetscSection,PetscInt,const_PetscInt*)
    int PetscSectionGetFieldConstraintIndices(PetscSection,PetscInt,PetscInt,const_PetscInt**)
    int PetscSectionSetFieldConstraintIndices(PetscSection,PetscInt,PetscInt,const_PetscInt*)
