...
.seealso: [](ch_ts), `TS`, `TSRHSFunction_Fn`, `IS`, `TSRHSSplitSetIS()`
@*/
PetscErrorCode TSRHSSplitSetRHSFunction(TS ts, const char splitname[], Vec r, TSRHSFunction_Fn *rhsfunc, void *ctx)
{
  TS_RHSSplitLink isplit;
  DM              dmc;
