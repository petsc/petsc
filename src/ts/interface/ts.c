...
PetscErrorCode TSComputeRHSJacobian(TS ts, PetscReal t, Vec U, Mat A, Mat B)
{
  ...
  DM                dm;
  DMTS              tsdm;
  TSRHSJacobian_Fn *rhsjacobianfunc;
  void             *ctx;
...
{
  TSSolution_Fn *solutionfunction;
  void          *ctx;
  DM             dm;
...
.seealso: [](ch_ts), `TS`, `TSRHSFunction_Fn`, `TSSetRHSJacobian()`, `TSSetIJacobian()`, `TSSetIFunction()`
@*/
PetscErrorCode TSSetRHSFunction(TS ts, Vec r, TSRHSFunction_Fn *f, void *ctx)
{
  SNES snes;
  Vec  ralloc = NULL;
  DM   dm;
...
.seealso: [](ch_ts), `TS`, `TSSolution_Fn`, `TSSetRHSJacobian()`, `TSSetIJacobian()`, `TSComputeSolutionFunction()`, `TSSetForcingFunction()`, `TSSetSolution()`, `TSGetSolution()`, `TSMonitorLGError()`, `TSMonitorDrawError()`
@*/
PetscErrorCode TSSetSolutionFunction(TS ts, TSSolution_Fn *f, void *ctx)
{
  DM dm;
...
.seealso: [](ch_ts), `TS`, `TSForcing_Fn`, `TSSetRHSJacobian()`, `TSSetIJacobian()`,
`TSComputeSolutionFunction()`, `TSSetSolutionFunction()`
@*/
PetscErrorCode TSSetForcingFunction(TS ts, TSForcing_Fn *func, void *ctx)
{
  DM dm;
...
.seealso: [](ch_ts), `TS`, `TSRHSJacobian_Fn`, `SNESComputeJacobianDefaultColor()`,
`TSSetRHSFunction()`, `TSRHSJacobianSetReuse()`, `TSSetIJacobian()`, `TSRHSFunction_Fn`, `TSIFunction_Fn`
@*/
PetscErrorCode TSSetRHSJacobian(TS ts, Mat Amat, Mat Pmat, TSRHSJacobian_Fn *f, void *ctx)
{
  SNES            snes;
  DM              dm;
  TSIJacobian_Fn *ijacobian;
...
.seealso: [](ch_ts), `TS`, `TSIFunction_Fn`, `TSSetRHSJacobian()`, `TSSetRHSFunction()`,
`TSSetIJacobian()`
@*/
PetscErrorCode TSSetIFunction(TS ts, Vec r, TSIFunction_Fn *f, void *ctx)
{
  SNES snes;
  Vec  ralloc = NULL;
  DM   dm;
...
@*/
PetscErrorCode TSGetIFunction(TS ts, Vec *r, TSIFunction_Fn **func, void **ctx)
{
  SNES snes;
  DM   dm;
...
@*/
PetscErrorCode TSGetRHSFunction(TS ts, Vec *r, TSRHSFunction_Fn **func, void **ctx)
{
  SNES snes;
  DM   dm;
...
.seealso: [](ch_ts), `TS`, `TSIJacobian_Fn`, `TSSetIFunction()`, `TSSetRHSJacobian()`,
`SNESComputeJacobianDefaultColor()`, `SNESComputeJacobianDefault()`, `TSSetRHSFunction()`
@*/
PetscErrorCode TSSetIJacobian(TS ts, Mat Amat, Mat Pmat, TSIJacobian_Fn *f, void *ctx)
{
  SNES snes;
  DM   dm;
...
/*@
  TSRHSJacobianSetReuse - restore the RHS Jacobian before calling the user-provided `TSRHSJacobian_Fn` function again
...
.seealso: [](ch_ts), `TS`, `TSI2Function_Fn`, `TSSetI2Jacobian()`, `TSSetIFunction()`,
`TSCreate()`, `TSSetRHSFunction()`
@*/
PetscErrorCode TSSetI2Function(TS ts, Vec F, TSI2Function_Fn *fun, void *ctx)
{
  DM dm;
...
@*/
PetscErrorCode TSGetI2Function(TS ts, Vec *r, TSI2Function_Fn **fun, void **ctx)
{
  SNES snes;
  DM   dm;
...
. jac - the Jacobian evaluation routine, see `TSI2Jacobian_Fn` for the calling sequence
- ctx - user-defined context for private data for the Jacobian evaluation routine (may be `NULL`)
...
.seealso: [](ch_ts), `TS`, `TSI2Jacobian_Fn`, `TSSetI2Function()`, `TSGetI2Jacobian()`
@*/
PetscErrorCode TSSetI2Jacobian(TS ts, Mat J, Mat P, TSI2Jacobian_Fn *jac, void *ctx)
{
  DM dm;
...
@*/
PetscErrorCode TSGetI2Jacobian(TS ts, Mat *J, Mat *P, TSI2Jacobian_Fn **jac, void **ctx)
{
  SNES snes;
  DM   dm;
...
.seealso: [](ch_ts), `TS`, `TSBDF`, `TSTransientVariable_Fn`, `DMTSSetTransientVariable()`, `DMTSGetTransientVariable()`, `TSSetIFunction()`, `TSSetIJacobian()`
@*/
PetscErrorCode TSSetTransientVariable(TS ts, TSTransientVariable_Fn *tvar, void *ctx)
{
  DM dm;
...
PetscErrorCode TSSetUp(TS ts)
{
  ...
  TSIFunction_Fn   *ifun;
  TSIJacobian_Fn   *ijac;
  TSI2Jacobian_Fn  *i2jac;
  TSRHSJacobian_Fn *rhsjac;
...
@*/
PetscErrorCode TSGetRHSJacobian(TS ts, Mat *Amat, Mat *Pmat, TSRHSJacobian_Fn **func, void **ctx)
{
  DM dm;
...
@*/
PetscErrorCode TSGetIJacobian(TS ts, Mat *Amat, Mat *Pmat, TSIJacobian_Fn **f, void **ctx)
{
  DM dm;
...
/*@C
  TSComputeIJacobianConstant - Reuses the matrix previously computed with the provided `TSIJacobian_Fn` for a semi-implicit DAE or ODE
