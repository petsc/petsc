...
.seealso: `TSGetTimeSpan()`, `TSGetTimeSpanSolutions()`
 @*/
...
.seealso: `TSSetTimeSpan()`, `TSGetTimeSpanSolutions()`
 @*/
...
/*@C
  TSPruneIJacobianColor - Remove nondiagonal zeros in the Jacobian matrix and update the MFFD coloring.
