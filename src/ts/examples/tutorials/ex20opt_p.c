...
/*TEST
    ...
    test:
      args:  -implicitform 0 -ts_type rk -ts_adapt_type none -mu 10 -ts_dt 0.1 -viewer_binary_skip_info -tao_monitor -tao_view -ts_trajectory_dirname ex20opt_pdir -ts_trajectory_use_history 0
    ...
    test:
      suffix: 3
      args:  -ts_type cn -ts_adapt_type none -mu 100 -ts_dt 0.01 -viewer_binary_skip_info -tao_monitor -tao_view -mu 100 -ts_dt 0.01 -ts_trajectory_dirname ex20opt_pdir -ts_trajectory_use_history 0
