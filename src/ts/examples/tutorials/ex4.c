/*$Id: ex4.c,v 1.29 2001/08/10 03:34:17 bsmith Exp $*/
...
int main(int argc,char **argv)
{
  ...
  */
  ...
  ierr = TSCreate(PETSC_COMM_WORLD,TS_LINEAR,&ts);CHKERRQ(ierr);
  ...
  ierr = MatCreate(PETSC_COMM_WORLD,PETSC_DECIDE,PETSC_DECIDE,m,m,&A);CHKERRQ(ierr);
