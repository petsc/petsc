                              ...
                              PetscInt pinterp,const PetscReal binterpt[])
{
  ...
  case 3: ierr = PetscKernel_A_gets_inverse_A_3(GammaInv,0,PETSC_TRUE,NULL);CHKERRQ(ierr); break;
...
PetscErrorCode TSRosWRegisterRos4(TSRosWType name,PetscReal gamma,PetscReal a2,PetscReal a3,PetscReal b3,PetscReal e4)
{
  ...
  ierr    = PetscKernel_A_gets_inverse_A_3(&M[0][0],0,PETSC_TRUE,NULL);CHKERRQ(ierr);
