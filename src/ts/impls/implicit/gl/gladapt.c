...
struct _TSGLAdaptOps {
  ...
  PetscErrorCode (*setfromoptions)(PetscOptionsObjectType*,TSGLAdapt);
};
...
PetscErrorCode  TSGLAdaptSetFromOptions(PetscOptionsObjectType *PetscOptionsObject,TSGLAdapt adapt)
{
  PetscErrorCode ierr;
