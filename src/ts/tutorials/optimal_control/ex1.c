...
int main(int argc, char **argv)
{
  ...
  PetscCall(TSSetRHSFunction(aircraft.quadts, NULL, (TSRHSFunction_Fn *)CostIntegrand, &aircraft));
  PetscCall(TSSetRHSJacobian(aircraft.quadts, aircraft.DRDU, aircraft.DRDU, (TSRHSJacobian)DRDUJacobianTranspose, &aircraft));
  PetscCall(TSSetRHSJacobianP(aircraft.quadts, aircraft.DRDP, (TSRHSJacobianP_Fn *)DRDPJacobianTranspose, &aircraft));
