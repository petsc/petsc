#ifndef lint
static char vcid[] = "$Id: bcgs.c,v 1.40 1996/12/18 23:17:12 balay Exp bsmith $";
#endif
...
#undef __FUNCTION__  
#define __FUNCTION__ "KSPSetUp_BCGS"
...
#undef __FUNCTION__  
#define __FUNCTION__ "KSPSolve_BCGS"
...
#undef __FUNCTION__  
#define __FUNCTION__ "KSPCreate_BCGS"
