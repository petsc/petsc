...
| sed -e 's/Level:[ \t][ \t]*beginner/\\ingroup dm-class-beginner\n Level: beginner/g' \
| sed -e 's/Level:[ \t][ \t]*intermediate/\\ingroup dm-class-intermediate\n Level: intermediate/g' \
| sed -e 's/Level:[ \t][ \t]*advanced/\\ingroup dm-class-advanced\n Level: advanced/g' \
| sed -e 's/Level:[ \t][ \t]*developer/\\ingroup dm-class-developer\n Level: developer/g' \
