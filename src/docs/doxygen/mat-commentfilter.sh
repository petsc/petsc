...
| sed -e 's/Level:[ \t][ \t]*beginner/\\ingroup mat-class-beginner\n Level: beginner/g' \
| sed -e 's/Level:[ \t][ \t]*intermediate/\\ingroup mat-class-intermediate\n Level: intermediate/g' \
| sed -e 's/Level:[ \t][ \t]*advanced/\\ingroup mat-class-advanced\n Level: advanced/g' \
| sed -e 's/Level:[ \t][ \t]*developer/\\ingroup mat-class-developer\n Level: developer/g' \
