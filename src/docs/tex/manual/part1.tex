...
Some examples are:
\begin{bashlisting}
      make -f gmakefile.test search='ts\%' test  # Run all ts examples
\end{bashlisting}
\begin{bashlisting}
      make -f gmakefile.test searchin='tutorials' test  # Run all tutorials
\end{bashlisting}
\begin{bashlisting}
      make -f gmakefile.test argsearch='cuda' test  # Run examples with cuda in arguments
\end{bashlisting}

Finally, it is useful before invoking the tests to see what targets will
be run.  The \trl{print-test} is useful for this:
\begin{bashlisting}
      make -f gmakefile.test argsearch='cuda' print-test
\end{bashlisting}
