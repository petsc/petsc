...
\noindent{\bf Note to Python Programmers}: \label{sec_petsc4py} \findex{petsc4py}
...
\trl{-help}\findex{-help} option as well as the \trl{-version}\findex{-version} option.
...
program. The error occurred on line 3618 of the file \trl{${PETSC_DIR}/src/mat/impls/aij/seq/aij.c} 
and was caused by trying to allocate too
