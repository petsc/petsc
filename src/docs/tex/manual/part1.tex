...
\item distributed arrays (useful for parallelizing regular grid-based 
      problems);
\item over fifteen Krylov subspace methods;
\item dozens of preconditioners, including multigrid, block solvers, and sparse direct solvers;
\item nonlinear solvers; and
\item timesteppers for solving time-dependent (nonlinear) PDEs, including support for differential algebraic equations (DAE).
\end{itemize}
...
accessed at \href{http://www.mcs.anl.gov/petsc/petsc-as/documentation}{http://www.mcs.anl.gov/petsc/petsc-as/documentation}.
The manual pages
...
for more details \href{http://www.mcs.anl.gov/petsc/petsc-as/documentation/installation.html}{http://www.mcs.anl.gov/petsc/petsc-as/documentation/installation.html}.
...
communicator, given by PETSC_COMM_WORLD, to \trl{MPI_COMM_WORLD}.
