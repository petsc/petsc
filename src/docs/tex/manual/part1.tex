...
Some examples are:
\begin{bashlisting}
      make -f gmakefile search='ts%' test  # Run all ts examples
\end{bashlisting}
\begin{bashlisting}
      make -f gmakefile searchin='tutorials' test  # Run all tutorials
\end{bashlisting}
\begin{bashlisting}
      make -f gmakefile argsearch='cuda' test  # Run examples with cuda in arguments
\end{bashlisting}
