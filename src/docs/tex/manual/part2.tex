...
\begin{tabbing}
  PetscLogEventRegister(const char string[],PetscEvent *e);
\end{tabbing}
...
\begin{tabbing}
   ...
   PetscLogStageRegister(&stagenum0,"Stage 0 of Code");\\
   for (i=0; i<ntimes; i++) \{\\
      PetscLogStageRegister(&stagenum1,"Stage 1 of Code");\\
      PetscLogStagePush(stagenum1);\\
      /* stage 1 of code here */\\
      PetscLogStagePop();\\
      PetscLogStageRegister(&stagenum2,"Stage 2 of Code");\\
