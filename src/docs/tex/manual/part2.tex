...
Zero will keep all non-zero edges, a negative number will keep zero edges, a positive number will drop small edge values.
...
Use \trl{-pc_gamg_sym_graph <true>} to symmetrize the graph if your problem is not numerically symmetric (it must be structurally symmetric).
