...
Restricted Broyden Family Diagonal                      & \lstinline|MATLMVMDiagBrdn|
& \trl{lmvmdiagbrdn}  & SPD \\
\hline
\end{tabular}
\end{center}
...
\end{itemize}
Note that the user-provided initial Jacobian via \lstinline{MatLMVMSetJ0()} overrides and disables all of these 
built-in initialization methods.
