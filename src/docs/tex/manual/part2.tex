...
The rate of coarsening is criticle in AMG performance -- too slow of coarsening will result in an overly expensive solver per iteration and too fast coarsening will result in decrease in the convergence rate. \trl{-pc_gamg_threshold <x>} and  \trl{-pc_gamg_square_graph <N>,} are the primary parameters that control coarsening rates.
