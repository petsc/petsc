...
the command
\begin{tabbing}
  MatZeroRowsIS(Mat A,PetscInt numRows,PetscInt rows[],PetscScalar diag\_value,Vec x,Vec b),
\end{tabbing}
or equivalently,
\begin{tabbing}
...
\begin{tabbing}
  ...
  ierr = DMDACreate3d(PETSC_COMM_WORLD,DMDA\_NONPERIODIC,DMDA_STENCIL_STAR,\\
