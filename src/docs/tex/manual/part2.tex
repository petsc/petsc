...
The effectiveness of the Schur complement preconditioner depends on the availability of a good preconditioner $S_p$ for the Schur complement matrix.
In general, the user is responsible for suppling $S_p$
