...
\begin{tabbing}
TSAdjointGetCostIntegral(TS ts,Vec *q). 
\end{tabbing}
If TSAdjointSetCostGradients() and TSAdjointSetCostGradients() are called before TSSolve(), the integral term will be evaluated in the forward run. 
