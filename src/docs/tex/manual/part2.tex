...
\hline
 ...
 sbaij        & cholesky     &                                   & \\
 plapack      & lu           &  MATSOLVERPLAPACK         & \trl{plapack}\\
 plapack      & cholesky     &                                   & \\
 aij          & lu           &  MATSOLVERSPOOLES         & \trl{spooles}\\
 sbaij        & cholesky     &                                   & \\
 seqaij       & lu           &  MATSOLVERSUPERLU         & \trl{superlu} \\
 aij          & lu           &  MATSOLVERSUPERLU_DIST    & \trl{superlu_dist}\\
...
\trl{-ksp_type preonly} \findex{-pc_type lu} \findex{-pc_factor_mat_solver_package mumps} \findex{-mat_mumps_icntl_7 2}:
