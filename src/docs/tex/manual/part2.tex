...
\findex{-pc_factor_drop_tolerance} \findex{-pc_factor_reuse_fill}
...
Note: currently only \trl{TSGL}, \trl{TSTHETA}, and \trl{TSPSEUDO} have
...
The value $ dt_{\text{increment}} $ is by default $ 1.1$, but can be reset with the 
call 
\begin{tabbing}
