...
interface are automatically coarsened.  FAS differs slightly from PCMG, in that the hierarchy is constructed
recursively.

There are three SNESFAS cycle types, \trl{SNES_FAS_MULTIPLICATIVE}, \trl{SNES_FAS_ADDITIVE}, \trl{SNES_FAS_FULL},
...
comma separated list argument to \trl{-snes_composite_sneses}.  There are additive, additive with optimal damping, and
multplicative variants which may be set with SNESCompositeSetType().
