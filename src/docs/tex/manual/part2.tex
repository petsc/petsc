...
{\bf Function Name} & {\bf Operation} \\
\hline
MatAXPY(Mat Y,Mat X, PetscScalar a,MatStructure); & $ Y = Y + a*X $ \\
...
\break \trl{${PETSC_DIR}/src/sys/src/draw/examples/tests/ex5f.F}, and 
...
\begin{figure}[H]
{\small
\fileinclude{../../../../src/sys/src/draw/examples/tests/ex5f.F}
}
