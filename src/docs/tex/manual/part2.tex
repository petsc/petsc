...
The PETSc AMG framework provides one basic aggregation AMG method (\texttt{-pc_gamg_type agg}) and the popular variant smoothed aggregation (\texttt{-pc_gamg_agg_nsmooths 1}).
