...
the relative error in the function evaluations, $e_{rel}$; the default is 100 $\times$ the square root of machine epsilon (about $10^{-6}$ in double precision), which assumes
