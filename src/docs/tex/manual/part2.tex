...
one of the following:  \trl{-pc_factor_mat_ordering_type} \trl{natural}, \trl{-pc_factor_mat_ordering_type}
\trl{nd}, \trl{-pc_factor_mat_ordering_type} \trl{1wd}, \trl{-pc_factor_mat_ordering_type} \trl{rcm},
\trl{-pc_factor_mat_ordering_type} \trl{qmd}.
...
\end{itemize}
These orderings can also be set through the options database by specifying 
one of the following:  \trl{-pc_factor_mat_ordering_type} \trl{natural}, \trl{-pc_factor_mat_ordering_type} \trl{nd}, 
\trl{-pc_factor_mat_ordering_type} \trl{1wd}, \trl{-pc_factor_mat_ordering_type} \trl{rcm}, \trl{-pc_factor_mat_ordering_type}
\trl{qmd}.
\findex{MATORDERING_NATURAL} \findex{MATORDERING_ND} \findex{MATORDERING_1WD}
\findex{MATORDERING_RCM} \findex{MATORDERING_QMD} \sindex{nested dissection}
\sindex{one-way dissection} \sindex{reverse Cuthill-McKee} 
