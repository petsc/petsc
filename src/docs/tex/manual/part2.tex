...
\end{itemize}
% Some experimentation required! Best choice depends on code, compiler, architecture.
% Some guidelines:
% * Make sure compiler will optimize for target architecture
% * Vectorization is enabled
% * Worth exploring value-unsafe optimizations, but must verify that numerical results are OK!
