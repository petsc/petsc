...
computer science background, experience programming in C, C++, python, or Fortran and experience using a debugger such as \trl{gdb} or \trl{dbx}, it
...
We welcome any reports of corrections for this document at \trl{petsc-maint@mcs.anl.gov}.
