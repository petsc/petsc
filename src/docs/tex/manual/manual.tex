...
%  ANL changed the style of its title pages, rather than reproduce the style in latex
%  we just stick in their pages
...
%\vspace{0.5in} \\
%{\rm This manual is intended for use with PETSc 3.0.0}}
%{95/11 - Revision 3.0.0}{December 2008}
