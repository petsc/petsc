...
If this block is in \lstinline{src/a/b/tutorials/ex1.c}, then it will create \lstinline{a_b_tutorials-ex1} test that
requires only one processor/thread, with no arguments, and diff the
resultant output with \lstinline{src/a/b/tutorials/output/ex1.out}.
...
This creates two tests.  Assuming that this is \lstinline{src/a/b/tutorials/ex1.c}, the tests would
...
\begin{outputlisting}
arch-darwin-master-double-debug/tests/sys/classes/viewer/tests/runex4_4.sh  -v
...
not ok diff-sys_classes_viewer_tests-ex4_4 /Users/patrick/petsc-master/lib/petsc/bin/petscdiff  /Users/patrick/petsc-master/src/sys/classes/viewer/tests/output/ex4a.out ex4_4.tmp > diff-runex4_4.out 2> diff-runex4_4.out
#	2a3,14
...
\begin{outputlisting}
cd $PETSC_ARCH/tests/sys/classes/viewer/tests/
\end{outputlisting}
...
\begin{outputlisting}
$PETSC_DIR/src/sys/classes/viewer/tests/output/ex4a.out
\end{outputlisting}
