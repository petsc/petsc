...
back context. you can control exactly what \lstinline{XXX}/\lstinline{DM} objects share a common \lstinline{DMXXX} object.
...
\end{lstlisting}
To obtain a new DMKSP object for which you can change the callback functions (or their contexts) without affecting the original DMKSP one calls
\begin{lstlisting}
  DM    dm_2;
  DMKSP dmksp;
  KSPGetDM(ksp_2,&dm_2);
...
\end{bashlisting}
To modify the test harness,  you can modify this file
\begin{bashlisting}
