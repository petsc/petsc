...
\begin{tabbing}
return PetscError(\=comm,\_\_LINE\_\_,\_\_FUNC\_\_,\_\_FILE\_\_,\_\_SDIR\_\_,error code,error type,\\
\> ''Error message'');
\end{tabbing}
...
with the code
\begin{tabbing}
Pe\=tscErrorCode PetscError(\=MPI\_Comm,int line,char *func,char* file,char *dir,error code, \\
 \> \> error type,char *mess)\\
\{ \\
  \> PetscErrorCode ierr;\\
  \>PetscFunctionBegin;\\
...
\begin{tabbing}
Pe\=tscErrorCode PetscPushErrorHandler(\=PetscErrorCode (*handler)(int,char *,char*,char*,\\
    \> \>                      PetscErrorCode,PetscErrorType,char*,void*),\\
   \>  \>                      void *ctx )\\
\{\\
  \> PetscErrorCode ierr;\\
  \>EH neweh; \\
...
\href{http://www.mcs.anl.gov/petsc/petsc-dev/include/petscerror.h.html}{include/petscerror.h}, the same generic
...
\href{http://www.mcs.anl.gov/petsc/petsc-dev/include/petsclog.h.html}{include/petsclog.h}. The source code for the profile logging
...
interface file for the operations, for example, \href{http://www.mcs.anl.gov/petsc/petsc-dev/src/mat/interface/matrix.c.html}{src/mat/interface/matrix.c}.
