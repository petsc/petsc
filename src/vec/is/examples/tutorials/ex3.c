...
/*T
    Concepts: Index set, indices, stride, accessing PETSc array from Fortran
    Routines: ISCreateStrideSeq(), ISDestroy(), ISView()
...
int main(int argc,char **argv)
{
  ...
  */
  ierr = ISCreateStrideSeq(MPI_COMM_SELF,n,first,step,&set); CHKERRA(ierr);
