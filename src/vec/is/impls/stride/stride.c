#ifndef lint
static char vcid[] = "$Id: stride.c,v 1.49 1996/12/17 16:22:00 balay Exp balay $";
#endif
/*
...
#undef __FUNCTION__  
#define __FUNCTION__ "ISInvertPermutation_Stride"
...
#undef __FUNCTION__  
#define __FUNCTION__ "ISStrideGetInfo"
/*@
...
#undef __FUNCTION__  
#define __FUNCTION__ "ISDestroy_Stride"
...
#undef __FUNCTION__  
#define __FUNCTION__ "ISGetIndices_Stride"
...
#undef __FUNCTION__  
#define __FUNCTION__ "ISRestoreIndices_Stride"
...
#undef __FUNCTION__  
#define __FUNCTION__ "ISGetSize_Stride"
...
#undef __FUNCTION__  
#define __FUNCTION__ "ISView_Stride"
...
#undef __FUNCTION__  
#define __FUNCTION__ "ISSort_Stride"
...
#undef __FUNCTION__  
#define __FUNCTION__ "ISSorted_Stride"
...
#undef __FUNCTION__  
#define __FUNCTION__ "ISCreateStride"
/*@C
...
int ISCreateStride(MPI_Comm comm,int n,int first,int step,IS *is)
{
  ...
  *is = 0;
  if (n < 0) SETERRQ(1,"Number of indices < 0");
