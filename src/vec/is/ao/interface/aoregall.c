...
PetscErrorCode  AORegisterAll(void)
{
  ...
  ierr = AORegister(AOBASIC,          "AOCreate_Basic",          AOCreate_Basic);CHKERRQ(ierr);
  ierr = AORegister(AOMEMORYSCALABLE, "AOCreate_MemoryScalable", AOCreate_MemoryScalable);CHKERRQ(ierr);
