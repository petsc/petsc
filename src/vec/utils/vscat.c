#ifndef lint
static char vcid[] = "$Id: vscat.c,v 1.17 1995/05/03 00:04:23 curfman Exp bsmith $";
#endif
...
$    SCATTERALL, SCATTERUP, SCATTERDOWN, 
$    SCATTERREVERSE, SCATTERALLREVERSE
...
.  addv - either ADDVALUES or INSERTVALUES, depending whether values are
   added or set
.  mode - the scattering mode, usually SCATTERALL.  The available modes are:
$    SCATTERALL, SCATTERUP, SCATTERDOWN, SCATTERREVERSE
$    Note:  SCATTERALL and SCATTERREVERSE can be combined 
$    with bitwise inclusive or (SCATTERALL | SCATTERREVERSE)
.  inctx - scatter context generated by VecScatterCtxCreate()
...
.  addv - either ADDVALUES or INSERTVALUES, depending whether values are
          added or set
.  inctx - scatter context generated by VecScatterCtxCreate()
.  mode - pipelining mode, either PIPELINEUP or PIPELINEDOWN
