...
PetscErrorCode PETSCVEC_DLLEXPORT VecBlockSetSubVecs_Block( 
																			 Vec V, 
...
PetscErrorCode PETSCVEC_DLLEXPORT VecBlockSetSubVecs( 
																 Vec V, 
																 PetscInt m, const PetscInt idxm[],
																 const Vec vec[] )
{
...
PetscErrorCode PETSCVEC_DLLEXPORT VecBlockSetSubVec_Block( 
																			 Vec V, 
																			 const PetscInt idxm,
																			 const Vec vec )
{
...
PetscErrorCode PETSCVEC_DLLEXPORT VecBlockSetSubVec( 
																 Vec V, 
																 const PetscInt idxm,
																 const Vec vec )
{
...
PetscErrorCode PETSCVEC_DLLEXPORT _VecBlockGetValues(Vec x,
																	PetscInt m, const PetscInt idxm[],
																	Vec vec[] )
{
