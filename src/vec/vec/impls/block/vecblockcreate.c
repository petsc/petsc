...
EXTERN_C_BEGIN
PetscErrorCode PETSCVEC_DLLEXPORT VecBlockSetSubVecs_Block(Vec,PetscInt,const PetscInt[],const Vec[]);
PetscErrorCode PETSCVEC_DLLEXPORT VecBlockSetSubVec_Block(Vec,const PetscInt,const Vec);
PetscErrorCode PETSCVEC_DLLEXPORT VecBlockGetSubVec_Block(Vec,PetscInt,Vec*);
...
PetscErrorCode PETSCVEC_DLLEXPORT VecCreate_Block( Vec V )
{
  ...
  /* expose block api's */
  ierr = PetscObjectComposeFunctionDynamic((PetscObject)V,"VecBlockSetSubVec_C","VecBlockSetSubVec_Block",VecBlockSetSubVec_Block);CHKERRQ(ierr);
  ierr = PetscObjectComposeFunctionDynamic((PetscObject)V,"VecBlockSetSubVecs_C","VecBlockSetSubVecs_Block",VecBlockSetSubVecs_Block);CHKERRQ(ierr);
  ierr = PetscObjectComposeFunctionDynamic((PetscObject)V,"VecBlockGetSubVec_C","VecBlockGetSubVec_Block",VecBlockGetSubVec_Block);CHKERRQ(ierr);
  ierr = PetscObjectComposeFunctionDynamic((PetscObject)V,"VecBlockGetSubVecs_C","VecBlockGetSubVecs_Block",VecBlockGetSubVecs_Block);CHKERRQ(ierr);
  PetscFunctionReturn(0);
}
EXTERN_C_END
