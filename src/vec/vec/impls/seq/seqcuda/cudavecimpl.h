...
PETSC_INTERN PetscErrorCode VecCopy_SeqCUDA(Vec,Vec);
...
PETSC_INTERN PetscErrorCode VecCUDAAllocateCheckHost(Vec);
...
PETSC_INTERN PetscErrorCode VecCUDAAllocateCheck(Vec v);
