...
PETSC_EXTERN_C void PETSC_STDCALL vecscattercreate_(Vec *xin,IS *ix,Vec *yin,IS *iy,VecScatter *newctx,PetscErrorCode *ierr)
{
...
PETSC_EXTERN_C void PETSC_STDCALL vecscatterremap_(VecScatter *scat,PetscInt *rto,PetscInt *rfrom, int *ierr)
{
...
PETSC_EXTERN_C void PETSC_STDCALL  vecscatterdestroy_(VecScatter *ctx, int *__ierr)
{
