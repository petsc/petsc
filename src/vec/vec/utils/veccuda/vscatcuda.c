...
/*@
 ...
 SpMV call in MatMult_MPIAIJCUDA (in mpi/mpicuda/mpiaijcuda.cu) or MatMult_MPIAIJCUDAARSE
 (in mpi/mpicudaarse/mpiaijcudaarse.cu). This function is executed before the call to
...
/*@
 ...
 in MatMult_MPIAIJCUDA (in mpi/mpicuda/mpiaijcuda.cu) or MatMult_MPIAIJCUDAARSE
 (in mpi/mpicudaarse/mpiaijcudaarse.cu). Once the MatMultAdd is finished,
