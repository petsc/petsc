...
PETSC_EXTERN void PETSC_STDCALL petscdsgettabulation_(PetscDS *prob, PetscInt *f, F90Array1d *ptrB, F90Array1d *ptrD, PetscErrorCode *ierr PETSC_F90_2PTR_PROTO(ptrb) PETSC_F90_2PTR_PROTO(ptrd))
{
  ...
  *ierr = F90Array1dCreate((void *) basis[*f],    PETSC_REAL, 1, Nb*Nc, ptrB PETSC_F90_2PTR_PARAM(ptrb));if (*ierr) return;
  *ierr = F90Array1dCreate((void *) basisDer[*f], PETSC_REAL, 1, Nb*Nc*dim, ptrD PETSC_F90_2PTR_PARAM(ptrd));
}
