...
namespace ALECompat {
  namespace PyLith {
    ...
    class Builder {
    public:
      typedef ALECompat::Mesh::topology_type     topology_type;
      typedef topology_type::sieve_type    sieve_type;
      typedef ALECompat::Mesh::real_section_type real_section_type;
      typedef ALECompat::Mesh::int_section_type  int_section_type;
      typedef ALECompat::Mesh::pair_section_type pair_section_type;
    public:
      Builder() {};
      virtual ~Builder() {};
