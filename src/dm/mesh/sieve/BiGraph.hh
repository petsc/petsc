...
namespace ALE {
  ...
  namespace Two {
    ...
    private:
      ...
      // Arrow record
      typedef ALE::def::Arrow<source_type,target_type,color_type> Arrow_;
      typedef ALE::def::Arrow<source_type,target_type,color_type> arrow_type;
      // Arrow record set
      typedef ::boost::multi_index::multi_index_container<
        arrow_type,
        ::boost::multi_index::indexed_by<
    ...
    public:
      ...
      class baseSequence : 
        public OutputSequence<BasePointSet, degreeTag, BOOST_MULTI_INDEX_MEMBER(BasePoint,typename BasePoint::point_type,point)> {
      public:
