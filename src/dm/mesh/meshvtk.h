...
class VTKViewer {
 public:
  ...
  static PetscErrorCode writeField(ALE::Obj<ALE::Mesh> mesh, ALE::Obj<ALE::Mesh::field_type> field, const std::string& name, const int fiberDim, PetscViewer viewer, int enforceDim = -1) {
    PetscErrorCode ierr;
