...
static char vcid[] = "$Id: aodatabasic.c,v 1.11 1997/10/10 04:07:52 bsmith Exp bsmith $";
#endif
...
int AODataRestoreLocalSegment_Basic(AOData aodata,char *name,char *segname,int n,int *keys,void **data)
{
  PetscFree(*data);
  PetscFunctionReturn(0);
}
