...
int main(int argc, char *argv[])
{
  ...
  memTest   = PETSC_TRUE;
  ierr      = PetscOptionsBool("-mem_test", "Perform the mem test", "ex0.c", PETSC_TRUE, &memTest, NULL);CHKERRQ(ierr);
  arrowTest = PETSC_TRUE;
  ierr      = PetscOptionsBool("-arrow_test", "Perform the arrow test", "ex0.c", PETSC_TRUE, &arrowTest, NULL);CHKERRQ(ierr);
  coneTest  = PETSC_TRUE;
  ierr      = PetscOptionsBool("-cone_test", "Perform the cone test", "ex0.c", PETSC_TRUE, &coneTest, NULL);CHKERRQ(ierr);
