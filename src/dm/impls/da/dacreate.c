...
{
  PetscErrorCode   ierr;
  PetscInt         dim,m,n,p,dof,swidth,num = 1;
  ...
  PetscFunctionBegin;
  ierr = PetscViewerBinaryRead(viewer,&dim,&num,PETSC_INT);CHKERRQ(ierr);
  ierr = PetscViewerBinaryRead(viewer,&m,&num,PETSC_INT);CHKERRQ(ierr);
  ierr = PetscViewerBinaryRead(viewer,&n,&num,PETSC_INT);CHKERRQ(ierr);
  ierr = PetscViewerBinaryRead(viewer,&p,&num,PETSC_INT);CHKERRQ(ierr);
  ierr = PetscViewerBinaryRead(viewer,&dof,&num,PETSC_INT);CHKERRQ(ierr);
  ierr = PetscViewerBinaryRead(viewer,&swidth,&num,PETSC_INT);CHKERRQ(ierr);
  ierr = PetscViewerBinaryRead(viewer,&bx,&num,PETSC_ENUM);CHKERRQ(ierr);
  ierr = PetscViewerBinaryRead(viewer,&by,&num,PETSC_ENUM);CHKERRQ(ierr);
  ierr = PetscViewerBinaryRead(viewer,&bz,&num,PETSC_ENUM);CHKERRQ(ierr);
  ierr = PetscViewerBinaryRead(viewer,&stencil,&num,PETSC_ENUM);CHKERRQ(ierr);
  ...
  ierr = PetscViewerBinaryRead(viewer,&coors,&num,PETSC_ENUM);CHKERRQ(ierr);
  if (coors) {
