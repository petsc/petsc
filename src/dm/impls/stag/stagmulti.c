...
PETSC_INTERN PetscErrorCode DMStagPopulateInterpolation1d_a_b_Private(DM dmc, DM dmf, Mat A)
{
  ...
  for (exf = startexf; exf < startexf + nexf + nextraxf; ++exf) {
    ...
    if (dof[1] > 0 && exf < startexf + nexf) {
      ...
      rowf.i   = exf;
      rowf.c   = 0;
      rowf.loc = DMSTAG_ELEMENT; /* Note that this assumes only 1 dof */
      colc.i   = exc;
      colc.c   = 0;
      colc.loc = DMSTAG_ELEMENT;
      PetscCall(DMStagStencilToIndexLocal(dmf, dim, 1, &rowf, &ir));
      PetscCall(DMStagStencilToIndexLocal(dmc, dim, 1, &colc, &ic));
          ...
          if (exf_local % 2 == 0) {
            if (boundary_y) {
              ...
              if (boundary_z) {
                ...
                colc[1].loc           = DMSTAG_LEFT;
                colc[2].i             = exc;
                colc[2].j             = eyc + eyc_offset;
                colc[2].k             = ezc;
                colc[2].c             = 0;
                colc[2].loc           = DMSTAG_LEFT;
                colc[3].i             = exc;
                colc[3].j             = eyc + eyc_offset;
                colc[3].k             = ezc + ezc_offset;
                colc[3].c             = 0;
                colc[3].loc           = DMSTAG_LEFT;
              }
            }
          } else {
            colc[1].i   = exc;
            ...
            if (boundary_y) {
              if (boundary_z) {
                ...
                nweight   = 4;
                weight[0] = weight[1] = 0.5 * 0.75;
                weight[2] = weight[3] = 0.5 * 0.25;
                colc[2].i             = exc;
                colc[2].j             = eyc;
                colc[2].k             = ezc + ezc_offset;
                colc[2].c             = 0;
                colc[2].loc           = DMSTAG_LEFT;
                colc[3].i             = exc;
                colc[3].j             = eyc;
              ...
              if (boundary_z) {
                ...
                colc[3].loc           = DMSTAG_RIGHT;
                colc[4].i             = exc;
                colc[4].j             = eyc + eyc_offset;
                colc[4].k             = ezc;
                colc[4].c             = 0;
                colc[4].loc           = DMSTAG_LEFT;
                colc[5].i             = exc;
                colc[5].j             = eyc + eyc_offset;
                colc[5].k             = ezc;
                colc[5].c             = 0;
                colc[5].loc           = DMSTAG_RIGHT;
                colc[6].i             = exc;
                colc[6].j             = eyc + eyc_offset;
                colc[6].k             = ezc + ezc_offset;
                colc[6].c             = 0;
                colc[6].loc           = DMSTAG_LEFT;
                colc[7].i             = exc;
                colc[7].j             = eyc + eyc_offset;
                colc[7].k             = ezc + ezc_offset;
                colc[7].c             = 0;
          ...
          if (eyf_local % 2 == 0) {
            if (boundary_x) {
              ...
              if (boundary_z) {
                ...
                colc[1].c             = 0;
                colc[1].loc           = DMSTAG_DOWN;
                colc[2].i             = exc + exc_offset;
                colc[2].j             = eyc;
                colc[2].k             = ezc;
                colc[2].c             = 0;
                colc[2].loc           = DMSTAG_DOWN;
                colc[3].i             = exc + exc_offset;
                colc[3].j             = eyc;
                colc[3].k             = ezc + ezc_offset;
                colc[3].c             = 0;
                colc[3].loc           = DMSTAG_DOWN;
              }
            }
          } else {
            colc[1].i   = exc;
            ...
            if (boundary_x) {
              ...
              if (boundary_z) {
                ...
                colc[3].c             = 0;
                colc[3].loc           = DMSTAG_UP;
                colc[4].i             = exc + exc_offset;
                colc[4].j             = eyc;
                colc[4].k             = ezc;
                colc[4].c             = 0;
                colc[4].loc           = DMSTAG_DOWN;
                colc[5].i             = exc + exc_offset;
                colc[5].j             = eyc;
                colc[5].k             = ezc;
                colc[5].c             = 0;
                colc[5].loc           = DMSTAG_UP;
                colc[6].i             = exc + exc_offset;
                colc[6].j             = eyc;
                colc[6].k             = ezc + ezc_offset;
                colc[6].c             = 0;
                colc[6].loc           = DMSTAG_DOWN;
                colc[7].i             = exc + exc_offset;
                colc[7].j             = eyc;
                colc[7].k             = ezc + ezc_offset;
                colc[7].c             = 0;
...
PETSC_INTERN PetscErrorCode DMStagPopulateRestriction1d_a_b_Private(DM dmc, DM dmf, Mat A)
{
  ...
  for (exf = startexf; exf < startexf + nexf + nextraxf; ++exf) {
    ...
    if (exf_local % 2 == 0) {
      ...
      rowc[0].i   = exc;
      rowc[0].c   = 0;
      rowc[0].loc = DMSTAG_LEFT;
      rowc[1].i   = exc;
      rowc[1].c   = 0;
      rowc[1].loc = DMSTAG_RIGHT;
  ...
  for (eyf = starteyf; eyf < starteyf + neyf + nextrayf; ++eyf) {
    ...
    for (exf = startexf; exf < startexf + nexf + nextraxf; ++exf) {
      ...
      if (exf < startexf + nexf) {
        ...
        colf.j      = eyf;
        colf.c      = 0;
        colf.loc    = DMSTAG_DOWN;
        rowc[0].i   = exc;
        rowc[0].j   = eyc;
        rowc[0].c   = 0;
        rowc[0].loc = DMSTAG_DOWN;
        if (eyf_local % 2 == 0) {
          nweight = 1;
          if (eyf == Neyf || eyf == 0) {
            /* Note - this presumes something like a Neumann condition, assuming
    ...
    for (eyf = starteyf; eyf < starteyf + neyf + nextrayf; ++eyf) {
      ...
      for (exf = startexf; exf < startexf + nexf + nextraxf; ++exf) {
        ...
        if (exf < startexf + nexf && eyf < starteyf + neyf) {
          ...
          colf.k      = ezf;
          colf.c      = 0;
          colf.loc    = DMSTAG_BACK;
          rowc[0].i   = exc;
          rowc[0].j   = eyc;
          rowc[0].k   = ezc;
          rowc[0].c   = 0;
          rowc[0].loc = DMSTAG_BACK;
          if (ezf_local % 2 == 0) {
            nweight = 1;
            if (ezf == Nezf || ezf == 0) {
              /* Note - this presumes something like a Neumann condition, assuming
