...
/*TEST
  ...
  test:
    ...
    args: -faces 2,3,2 -partitioning parmetis -repartitioning ptscotch -dp1_petscpartitioner_ptscotch_strategy BALANCE -dp1_petscpartitioner_ptscotch_imbalance 0.001 -dp1_petscpartitioner_view -dp2_mat_partitioning_ptscotch_strategy BALANCE -dp2_mat_partitioning_ptscotch_imbalance 0.001 -dp2_petscpartitioner_view
  test:
