...
.seealso: DMLoad(), DMPlexCoordinatesLoad(), DMView(), PetscViewerHDF5Open(), PetscViewerPushFormat()
@*/
...
.seealso: DMLoad(), DMPlexTopologyLoad(), DMView(), PetscViewerHDF5Open(), PetscViewerPushFormat()
@*/
