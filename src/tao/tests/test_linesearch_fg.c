...
int main( int argc, char **argv )
{
  ...
  */
  ierr = DMDACreate2d(PETSC_COMM_WORLD,DMDA_BOUNDARY_NONE,DMDA_BOUNDARY_NONE,DMDA_STENCIL_STAR,user.nx,user.ny,Nx,Ny,1,1,PETSC_NULL,PETSC_NULL,&user.dm);CHKERRQ(ierr);
