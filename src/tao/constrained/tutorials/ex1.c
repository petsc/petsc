...
PetscErrorCode main(int argc,char **argv)
{
  ...
  PetscAssertFalse(size>2,PETSC_COMM_SELF,PETSC_ERR_WRONG_MPI_SIZE,"More than 2 processors detected. Example written to use max of 2 processors.");
...
#else
  PetscAssertFalse(size > 1,PetscObjectComm((PetscObject)pc),PETSC_ERR_SUP,"Requires an external package that supports parallel PCCHOLESKY, e.g., MUMPS.");
#endif
