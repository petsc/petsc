...
/*TEST
   ...
   test:
      suffix: 5
      # the tolerance on this test has been set high because convergence appears to be unstable
      args: -tao_converged_reason -tao_gatol 1.e-1 -tao_almm_type classic -no_eq -tao_almm_subsolver_tao_max_it 100
