...
PetscErrorCode InitializeProblem(AppCtx *user)
{
  ...
  PetscAssertFalse(nrows != user->n,comm,PETSC_ERR_ARG_SIZ,"H: nrows != n");
  PetscAssertFalse(ncols != user->n,comm,PETSC_ERR_ARG_SIZ,"H: ncols != n");
  ...
  if (ierr) {
    ...
    PetscAssertFalse(ncols != user->n,comm,PETSC_ERR_ARG_SIZ,"Aeq ncols != H nrows");
  ...
  if (ierr) {
    ...
    PetscAssertFalse(nrows != user->me,comm,PETSC_ERR_ARG_SIZ,"Aeq nrows != Beq n");
