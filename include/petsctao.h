...
PETSC_EXTERN PetscErrorCode TaoMonitorDefault(Tao, PetscCtx);
PETSC_EXTERN PetscErrorCode TaoMonitorGlobalization(Tao, PetscCtx);
PETSC_EXTERN PetscErrorCode TaoMonitorDefaultShort(Tao, PetscCtx);
PETSC_EXTERN PetscErrorCode TaoMonitorConstraintNorm(Tao, PetscCtx);
PETSC_EXTERN PetscErrorCode TaoMonitorSolution(Tao, PetscCtx);
PETSC_EXTERN PetscErrorCode TaoMonitorResidual(Tao, PetscCtx);
PETSC_EXTERN PetscErrorCode TaoMonitorGradient(Tao, PetscCtx);
PETSC_EXTERN PetscErrorCode TaoMonitorStep(Tao, PetscCtx);
