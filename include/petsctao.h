...
PETSC_EXTERN PetscErrorCode TaoSetResidualJacobianRoutine(Tao, Mat, Mat, PetscErrorCode(*)(Tao, Vec, Mat, Mat, void*), void*);
...
PETSC_EXTERN PetscErrorCode TaoComputeResidualJacobian(Tao, Mat, Mat);
