...
PETSC_EXTERN PetscErrorCode TaoBLMVMSetH0(Tao, Mat);
PETSC_EXTERN PetscErrorCode TaoBLMVMGetH0(Tao, Mat*);
PETSC_EXTERN PetscErrorCode TaoBLMVMGetH0KSP(Tao, KSP*);
