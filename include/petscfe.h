...
PETSC_EXTERN PetscErrorCode PetscFEIntegrateBdResidual(PetscDS, PetscHashFormKey, PetscInt, PetscFEGeom *, const PetscScalar[], const PetscScalar[], PetscDS, const PetscScalar[], PetscReal, PetscScalar[]);
