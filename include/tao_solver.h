...
extern PetscCookie PETSC_DLLEXPORT TAO_SOLVER_COOKIE;
...
EXTERN PetscErrorCode PETSC_DLLEXPORT TaoSolverSetObjective(TaoSolver, PetscErrorCode(*)(TaoSolver, Vec, PetscScalar*,void*), void*);
