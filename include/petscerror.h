/* $Id: petscerror.h,v 1.24 1998/09/23 00:54:17 bsmith Exp bsmith $ */
/*
...
#define PetscCheckHeap PetscTrValid(__LINE__,__FUNC__,__FILE__,__SDIR__);
#else
#define PetscCheckHeap 
#endif
