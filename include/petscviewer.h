...
PETSC_EXTERN PetscErrorCode PetscOptionsViewer_Private(PetscOptionsObjectType*,const char[],const char[],const char[],PetscViewer*,PetscViewerFormat *,PetscBool *);
