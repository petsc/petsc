...
PETSC_EXTERN PetscErrorCode PetscRandomAppendOptionsPrefix(PetscRandom, const char[]);
PETSC_EXTERN PetscErrorCode PetscRandomGetOptionsPrefix(PetscRandom, const char *[]);
