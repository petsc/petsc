...
PETSC_EXTERN PetscErrorCode DMLabelGetValueISGlobal(MPI_Comm, DMLabel, PetscBool, IS *);
...
PETSC_EXTERN PetscErrorCode DMLabelPropagatePush(DMLabel, PetscSF, MPI_Op, PetscErrorCode (*)(DMLabel, PetscInt, PetscInt, void *), void *);
