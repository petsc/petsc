...
PETSC_EXTERN PetscErrorCode ISLocalToGlobalMappingSetUseHashTable(ISLocalToGlobalMapping,PetscBool);
PETSC_EXTERN PetscErrorCode ISLocalToGlobalMappingGetUseHashTable(ISLocalToGlobalMapping,PetscBool*);
