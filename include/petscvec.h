...
EXTERN PetscErrorCode PETSCVEC_DLLEXPORT VecScatterCreateLocal_PtoS(PetscInt,PetscInt[],PetscInt[],PetscInt[],PetscInt,PetscInt[],PetscInt[],PetscInt[],PetscInt,VecScatter);
