...
/*MC
   DAVecGetArray1d - see DAVecGetArray()

   Synopsis:
   int DAVecGetArray1d(DA da,Vec vec, PetscScalar **array)

   Not Collective

   Input Parameters:
+   da - the DA object
-   vec - the vector we wish to access the array from
...
.seealso: DAVecRestoreArray1d(), DAVecGetArray(), DAVecRestoreArray()

M*/
#define DAVecGetArray1d(da,vec,ap)     DAVecGetArray(da,vec,(void**)ap)

/*MC
   DAVecGetArray2d - see DAVecGetArray()

   Synopsis:
   int DAVecGetArray2d(DA da,Vec vec, PetscScalar ***array)
...
.seealso: DAVecRestoreArray2d(), DAVecGetArray(), DAVecRestoreArray()

M*/
#define DAVecGetArray2d(da,vec,ap)     DAVecGetArray(da,vec,(void**)ap)

/*MC
   DAVecGetArray3d - see DAVecGetArray()

   Synopsis:
   int DAVecGetArray3d(DA da,Vec vec, PetscScalar **array)
...
.seealso: DAVecRestoreArray3d(), DAVecGetArray(), DAVecRestoreArray()

M*/
#define DAVecGetArray3d(da,vec,ap)     DAVecGetArray(da,vec,(void**)ap)

/*MC
   DAVecRestoreArray1d - see DAVecRestoreArray()

   Synopsis:
   int DAVecRestoreArray1d(DA da,Vec vec, PetscScalar **array)
...
.seealso: DAVecGetArray1d(), DAVecGetArray(), DAVecRestoreArray()

M*/
#define DAVecRestoreArray1d(da,vec,ap) DAVecRestoreArray(da,vec,(void**)ap)

/*MC
   DAVecRestoreArray2d - see DAVecRestoreArray()

   Synopsis:
   int DAVecRestoreArray2d(DA da,Vec vec, PetscScalar **array)
...
.seealso: DAVecGetArray2d(), DAVecGetArray(), DAVecRestoreArray()

M*/
#define DAVecRestoreArray2d(da,vec,ap) DAVecRestoreArray(da,vec,(void**)ap)

/*MC
   DAVecRestoreArray3d - see DAVecRestoreArray()

   Synopsis:
   int DAVecRestoreArray3d(DA da,Vec vec, PetscScalar **array)
...
.seealso: DAVecGetArray3d(), DAVecGetArray(), DAVecRestoreArray()

M*/
#define DAVecRestoreArray3d(da,vec,ap) DAVecRestoreArray(da,vec,(void**)ap)
