...
struct _SNESOps {
  ...
  PetscErrorCode (*setfromoptions)(PetscOptionsObjectType*,SNES);                       /* sets options from database */
...
PETSC_INTERN PetscErrorCode SNESSetFromOptions_VI(PetscOptionsObjectType*,SNES);
