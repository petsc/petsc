...
!  Flags for draw
!
      PetscEnum PETSC_DRAW_BASIC_COLORS,PETSC_DRAW_ROTATE
      parameter (PETSC_DRAW_BASIC_COLORS=33,PETSC_DRAW_ROTATE=-1)
!
!  Colors for drawing
!
      PetscEnum PETSC_DRAW_WHITE,PETSC_DRAW_BLACK,PETSC_DRAW_RED
      PetscEnum PETSC_DRAW_GREEN,PETSC_DRAW_CYAN,PETSC_DRAW_BLUE
      PetscEnum PETSC_DRAW_MAGENTA,PETSC_DRAW_AQUAMARINE
      PetscEnum PETSC_DRAW_FORESTGREEN,PETSC_DRAW_ORANGE,PETSC_DRAW_VIOLET
      PetscEnum PETSC_DRAW_BROWN,PETSC_DRAW_PINK,PETSC_DRAW_CORAL
      PetscEnum PETSC_DRAW_GRAY,PETSC_DRAW_YELLOW,PETSC_DRAW_GOLD
      PetscEnum PETSC_DRAW_LIGHTPINK,PETSC_DRAW_MEDIUMTURQUOISE
      PetscEnum PETSC_DRAW_KHAKI,PETSC_DRAW_DIMGRAY,PETSC_DRAW_YELLOWGREEN
      PetscEnum PETSC_DRAW_SKYBLUE,PETSC_DRAW_DARKGREEN
      PetscEnum PETSC_DRAW_NAVYBLUE,PETSC_DRAW_SANDYBROWN
      PetscEnum PETSC_DRAW_CADETBLUE,PETSC_DRAW_POWDERBLUE
      PetscEnum PETSC_DRAW_DEEPPINK,PETSC_DRAW_THISTLE
      PetscEnum PETSC_DRAW_LIMEGREEN,PETSC_DRAW_LAVENDERBLUSH
      ...
      PetscEnum BUTTON_NONE,BUTTON_LEFT,BUTTON_CENTER,BUTTON_RIGHT
