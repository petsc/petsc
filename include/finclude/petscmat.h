...
!
      ...
      parameter (MAT_ROW_ORIENTED=0,MAT_COLUMN_ORIENTED=1)
      parameter (MAT_ROWS_SORTED=2,MAT_COLUMNS_SORTED=3)
      parameter (MAT_NO_NEW_NONZERO_LOCATIONS=4)
      parameter (MAT_YES_NEW_NONZERO_LOCATIONS=5)
      parameter (MAT_SYMMETRIC=6,MAT_STRUCTURALLY_SYMMETRIC=7)
      parameter (MAT_NO_NEW_DIAGONALS=8,MAT_YES_NEW_DIAGONALS=9)
      parameter (MAT_INODE_LIMIT_1=10,MAT_INODE_LIMIT_2=11)
      parameter (MAT_INODE_LIMIT_3=12,MAT_INODE_LIMIT_4=13)
      parameter (MAT_INODE_LIMIT_5=14,MAT_IGNORE_OFF_PROC_ENTRIES=15)
      parameter (MAT_ROWS_UNSORTED=16,MAT_COLUMNS_UNSORTED=17)
      parameter (MAT_NEW_NONZERO_LOCATION_ERR=18)
      parameter (MAT_NEW_NONZERO_ALLOCATION_ERR=19)
      parameter (MAT_USE_HASH_TABLE=20)
      parameter (MAT_KEEP_ZEROED_ROWS=21)
      parameter (MAT_IGNORE_ZERO_ENTRIES=22)
      parameter (MAT_USE_INODES=81,MAT_DO_NOT_USE_INODES=23)
      parameter (MAT_NOT_SYMMETRIC=24,MAT_HERMITIAN=25)
      parameter (MAT_NOT_STRUCTURALLY_SYMMETRIC=26)
      parameter (MAT_NOT_HERMITIAN=27)
      parameter (MAT_SYMMETRY_ETERNAL=28,MAT_NOT_SYMMETRY_ETERNAL=29)
      parameter (MAT_USE_COMPRESSEDROW=30)
      parameter (MAT_DO_NOT_USE_COMPRESSEDROW=31)
      parameter (MAT_IGNORE_LOWER_TRIANGULAR=32)
      parameter (MAT_ERROR_LOWER_TRIANGULAR=33)
      parameter (MAT_GETROW_UPPERTRIANGULAR=34)
