...
!
      ...
      parameter(MATOP_MAT_MULT_TRANSPOSE=95)
      parameter(MATOP_MAT_MULT_TRANSPOSE_SYM=96)
      parameter(MATOP_MAT_MULT_TRANSPOSE_NUM=97)
      ...
      parameter(MATOP_MATCREATE=115)
      parameter(MATOP_MATGETGHOSTS=116)
      parameter(MATOP_MATILUDTFACTORSYMBOLIC=117) 
      parameter(MATOP_MATILUDTFACTORNUMERIC=118) 
      parameter(MATOP_MATMULDIAGONALBLOCK=119)
      parameter(MATOP_MATHERMITIANTRANSPOSE=120)
