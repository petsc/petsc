...
!
      ...
      parameter (MAT_USE_INODES=23,MAT_DO_NOT_USE_INODES=24)
      parameter (MAT_NOT_SYMMETRIC=25,MAT_HERMITIAN=26)
      parameter (MAT_NOT_STRUCTURALLY_SYMMETRIC=27)
      parameter (MAT_NOT_HERMITIAN=28)
      parameter (MAT_SYMMETRY_ETERNAL=29,MAT_NOT_SYMMETRY_ETERNAL=30)
      parameter (MAT_USE_COMPRESSEDROW=31)
      parameter (MAT_DO_NOT_USE_COMPRESSEDROW=32)
      parameter (MAT_IGNORE_LOWER_TRIANGULAR=33)
      parameter (MAT_ERROR_LOWER_TRIANGULAR=34)
      parameter (MAT_GETROW_UPPERTRIANGULAR=35)
