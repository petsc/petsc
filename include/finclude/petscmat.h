...
!
      PetscEnum MAT_ROW_ORIENTED,MAT_ROWS_SORTED
      ...
      parameter (MAT_ROWS_SORTED=1,MAT_COLUMNS_SORTED=2)
      parameter (MAT_NO_NEW_NONZERO_LOCATIONS=3)
      parameter (MAT_SYMMETRIC=4,MAT_STRUCTURALLY_SYMMETRIC=5)
      parameter (MAT_NEW_DIAGONALS=6)
      parameter (MAT_INODE_LIMIT_1=7,MAT_INODE_LIMIT_2=8)
      parameter (MAT_INODE_LIMIT_3=9,MAT_INODE_LIMIT_4=10)
      parameter (MAT_INODE_LIMIT_5=11,MAT_IGNORE_OFF_PROC_ENTRIES=12)
      parameter (MAT_NEW_NONZERO_LOCATION_ERR=13)
      parameter (MAT_NEW_NONZERO_ALLOCATION_ERR=14)
      parameter (MAT_USE_HASH_TABLE=15)
      parameter (MAT_KEEP_ZEROED_ROWS=16)
      parameter (MAT_IGNORE_ZERO_ENTRIES=17)
      parameter (MAT_USE_INODES=18)
      parameter (MAT_HERMITIAN=19)
      parameter (MAT_SYMMETRY_ETERNAL=20)
      parameter (MAT_USE_COMPRESSEDROW=21)
      parameter (MAT_IGNORE_LOWER_TRIANGULAR=22)
      parameter (MAT_ERROR_LOWER_TRIANGULAR=23)
      parameter (MAT_GETROW_UPPERTRIANGULAR=24)
