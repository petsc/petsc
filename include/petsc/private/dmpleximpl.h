...
PETSC_INTERN PetscErrorCode DMPlexComputeJacobian_Patch_Internal(DM, PetscSection, PetscSection, PetscInt, PetscInt, const PetscInt *, PetscReal, PetscReal, Vec, Vec, Mat, Mat, void *);
