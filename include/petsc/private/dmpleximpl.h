...
PETSC_EXTERN PetscErrorCode DMPlexTransferVecTree(DM,Vec,DM,Vec,PetscSF,PetscSF,PetscInt *,PetscInt *);
...
PETSC_INTERN PetscErrorCode DMPlexReconstructGradients_Internal(DM, PetscInt, PetscInt, Vec, Vec, Vec, Vec);
