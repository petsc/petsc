...
Placeholder for changes section.  These changes include new algorithms
(POUNDerS and LCL), redesign of TAO objects (now just TaoSolver and 
TaoLineSearch), removal of C++ requirement, and support for single and
quad (gnu only) precision arithmetic.
