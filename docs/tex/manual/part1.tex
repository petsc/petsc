% $Id: part1.tex,v 1.142 2001/04/07 02:35:18 bsmith Exp bsmith $ 
...
pieces of PETSc.  Figure \ref{fig:1} is a diagram of some 
...
\begin{figure}[hbt]
\centerline{\immediate \pdfximage height 3.4in {petscwww.pdf} \pdfrefximage \pdflastximage}
...
\begin{figure}[hbt]
\centerline{\immediate \pdfximage height 3.4in {zoom.pdf} \pdfrefximage \pdflastximage}
...
the {\em PETSc Users Manual} in its entirety, while \trl{intro.ps} 
...
\begin{verbatim}
   ${PETSC_DIR}bin/petscmpirun -np 8 petsc_program_name petsc_options
\end{verbatim}
that uses the information set in \trl{${PETSC_DIR}/bmake/${PETSC_ARCH}/base.site} to 
...
\ref{chapter:snes} describes the nonlinear solvers in detail. We recommend 
...
@TechReport{petsc-manual,
   Author      = "Satish Balay and William D. Gropp and Lois C. McInnes
                  and Barry F. Smith",
