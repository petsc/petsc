% $Id: part1.tex,v 1.135 2000/03/31 16:02:30 curfman Exp balay $ 
...
solaris, IRIX, etc.)  on which PETSc is being used.  The utility {\tt
...
\begin{verbatim}
   #include "petscsles.h"
\end{verbatim}
where {\tt petscsles.h} is the include file for the SLES component.
...
example, {\tt petscsles.h} includes {\tt petscmat.h} (matrices),
