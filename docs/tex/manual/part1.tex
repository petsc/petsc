% $Id: part1.tex,v 1.115 1998/04/28 04:00:15 curfman Exp balay $ 
...
the following utility that starts a Netscape session:
\begin{verbatim}
...
Section~\ref{sec:emacs}. Similarly, {\em vi} users may find the
...
in a calculation or communication. Communicators has the variable type
...
Currently some components have examples only in
