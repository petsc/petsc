...
\findex{TaoSolverCreate()} \findex{TaoSolverSetObjectiveAndGradientRoutine()}
\findex{TaoSolverSetRoutine()} \findex{TaoSolverSolve()}
\findex{TaoSolverDestroy()} \findex{TaoSolverSetInitialVector()}
