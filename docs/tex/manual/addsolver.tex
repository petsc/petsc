...
The details of this line search should be specified elsewhere, when
...
memory for the {\tt TAO\_CG} data structure. Notice that the TaoSolver object
now has a pointer to this data structure (\texttt{tao->data}) so it can be 
accessed by the other
functions involving this solver implemenation.
