...
\vspace{7mm}
\noindent \textbf{Elimination of the TaoApplication Object}. The largest change to the TAO programming interface is the elimination of the
...
\vspace{7mm}
\noindent \textbf{New Algorithms}. TAO 2.0 has a new algorithm for solving derivative-free nonlinear least
squares
...
\vspace{7mm}
\noindent \textbf{TaoLineSearch Object}. TAO 2.0 promotes the line search to a full object.  Any of the available 
...
\vspace{7mm}
\noindent \textbf{Better Adherence to PETSc Style}. TAO 2.0 features a tighter association with PETSc standards and practices.  All 
