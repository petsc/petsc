...
\begin{itemize}
  \item AMG          (the algebraic multigrid code of John Ruge and Klaus Stueben,
                     \trl{http://www.mgnet.org/mgnet-codes-gmd.html})
  \item BlockSolve95 (for parallel ICC(0) and ILU(0) preconditioning,
                     \trl{http://www.mcs.anl.gov/blocksolve})
  ...
  \item LUSOL        (sparse LU factorization code (part of MINOS) developed by Michael Saunders,
                     ...
                     \trl{http://www.sbsi-sol-optimize.com/},
  \item Matlab       
  \item ParMeTiS      (parallel graph partitioner, \trl{http://www-users.cs.umn.edu/~karypis/metis/})
  \item PVODE        (parallel ODE integrator, \trl{http://www.llnl.gov/CASC/PVODE})
  \item SPAI         (for parallel sparse approximate inverse preconditiong, 
                     \trl{http://www.sam.math.ethz.ch/~grote/spai/}).
\end{itemize}
