...
By default this will use one step of iterative refinement to improve the 
stability of the orthogonalization if a simple test indicates that it is needed.
...
The values for \trl{KSPGMRESCGSRefinementType} are \trl{KSP_GMRES_CGS_REFINEMENT_NONE},
\findex{KSP_GMRES_CGS_REFINEMENT_NONE},
