% $Id: part2.tex,v 1.224 1997/06/13 01:57:34 bsmith Exp bsmith $ 
%
% NOTES:  
...
The {\tt AOxxToxx()} routines all allow negative entries in the input 
...
include file, by {\tt typedef \_p_Object* Object;}, (for example, 
{\tt typedef \_p_Vec* Vec;}).  This organization
...
\_p_Object} from the application code. The exact details of {\tt
\_p_Object} may be changed at link time. This capability is extremely important
...
Each object structure (named {\tt \_p_Object}) consists of three parts:
...
by a particular implementation.  For example, the {\tt \_p_Vec}
