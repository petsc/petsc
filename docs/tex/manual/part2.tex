...
\begin{figure}[tb]
\centerline{ \pdfximage  {ghost.pdf} \pdfrefximage \pdflastximage}
...
\begin{figure}[tb]
\centerline{ \pdfximage height 4.7in {danumbering.pdf} \pdfrefximage \pdflastximage}
...
\begin{figure}[H]
\centerline{ \pdfximage height 3in {usg.pdf} \pdfrefximage \pdflastximage}
