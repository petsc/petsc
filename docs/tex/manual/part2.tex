% $Id: part2.tex,v 1.195 1997/02/04 04:16:11 bsmith Exp bsmith $ 
%
% NOTES:  
...
{\tt PCASMType} is one of {\tt PC\_ASM\_BASIC, PC\_ASM\_RESTRICT,
PC\_ASM\_INTERPOLATE, PC\_ASM\_NONE} \findex{PCASMSetType()} and may also be set with the
options database {\tt -pc\_asm\_type 3, 2, 1, or 0}. \findex{-pc_asm_type}
Type {\tt PC\_ASM\_RESTRICT} uses a full restriction operator, but during the
interpolation process ignores the off processor values. Similarly, 
{\tt PC\_ASM\_INTERPOLATE} uses a limited restriction process, but uses a full
interpolation. 
The ASM types with limited restriction or interpolation were suggested by 
Xiao-Chuan Cai.  \index{Cai, Xiao-Chuan} The default is {\tt PC\_ASM\_INTERPOLATE}.
...
MatGetColoring()}. \findex{-mat_coloring} \findex{COLORING_SL} \findex{COLORING_ID}
\findex{COLORING_LF}
...
The most important line in this makefile is the line starting {\tt include}; 
...
The two most important lines in the makefile of Figure \ref{fig:make2}
