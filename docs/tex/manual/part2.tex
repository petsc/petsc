% $Id: part2.tex,v 1.298 1999/01/13 21:49:12 bsmith Exp bsmith $ 
%
% NOTES:  
...
\item {\tt VIEWER\_DRAWX\_WORLD} \findex{VIEWER_DRAW_WORLD} causes the 
      object to be drawn in a default X window.
\item {\tt VIEWER\_DRAWX\_SELF} \findex{VIEWER_DRAW_SELF} causes the 
      object to be drawn in a default X window.
