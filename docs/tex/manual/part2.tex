% $Id: part2.tex,v 1.186 1997/01/18 22:49:35 bsmith Exp curfman $ 
%
% NOTES:  
...
The parameter {\tt rerror} should be set to be the square root of the 
...
Note setting this parameter appropriately is crucial for achieving
fast convergence with matrix-free Newton-Krylov methods.  The 
...
in their application codes, but can take advantage of this feature
if desired by setting this macro before each user-define routine
that may call {\tt SETERRQ()}, {\tt SETERRA()}, {\tt CHKERRQ()},
or {\tt CHKERRA()}  For example,
\begin{verbatim}
    #undef __FUNC__  
