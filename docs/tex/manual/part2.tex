...
\begin{verbatim}
   PetscErrorCode TaoSetHessianRoutine(TaoSolver,Mat H, Mat Hpre,
...
\begin{verbatim}
   PetscErrorCode TaoSetJacobianRoutine(TaoSolver,Mat J, Mat Jpre,
                PetscErrorCode (*)(TaoSolver,Vec,Mat*,Mat*,MatStructure*,void*),
                void *);
\end{verbatim}
...
with {\tt TaoSetObjectiveRoutine()} and {\tt TaoSetGradientRoutine}.
...
\begin{verbatim}
   TaoSetConstraintRoutine(TaoSolver,
                           PetscErrorCode (*)(TaoSolver,Vec,Vec,void*),
                           void*);
\end{verbatim}
\noindent
...
\begin{verbatim}
   PetscErrorCode TaoSetMonitor(TaoSolver,
...
and {\tt TaoSetMaximumIterations()}\findex{TaoSetMaximumIterations()}.
...
\begin{verbatim}
   ierr = TaoGetSolutionStatus(TaoSolver tao, PetscInt *iterate, 
