% $Id: part2.tex,v 1.290 1998/10/05 19:05:44 bsmith Exp bsmith $ 
%
% NOTES:  
...
\begin{verbatim}
   ierr = MatSNESFDMFSetParameters(Mat mat,double rerror,double umin);
\end{verbatim}
\findex{SNESMatrixFreeSetParameters()}
