% $Id: part2.tex,v 1.261 1998/04/13 21:08:48 bsmith Exp bsmith $ 
%
% NOTES:  
...
the ParMETIS (developed by George Karypis), to allow the partitioning to be done in
...
command
\begin{verbatim}
  ierr = MatCreateMPIAdj(MPI_Comm comm,int mlocal,int n,int *ia,int *ja, Mat *A);
\end{verbatim}
