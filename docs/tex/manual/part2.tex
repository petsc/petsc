...
In addition, SNES provides a way to register new routines to compute the h-differencing parameter;
...
are given in Figures \ref{fig_vec-Fortran} - \ref{fig_SNES-Fortran},
corresponding to
