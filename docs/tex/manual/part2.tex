% $Id: part2.tex,v 1.347 2000/11/10 16:48:29 bsmith Exp bsmith $ 
%
% NOTES:  
...
the viewer set the output type with \url{ViewerSetFormat(viewer,PETSC_VIEWER_FORMAT_ASCII_MATLAB,char *name)} or
\url{ViewerPushFormat(viewer,PETSC_VIEWER_FORMAT_ASCII_MATLAB,char *name)}. \findex{VIEWER_FORMAT_ASCII_MATLAB}
\begin{verbatim}
  PetscViewerSetFormat(PETSC_VIEWER_STDOUT_WORLD,PETSC_VIEWER_FORMAT_ASCII_MATLAB,''VecA'');
  VecView(A,PETSC_VIEWER_STDOUT_WORLD);
  PetscViewerSetFormat(PETSC_VIEWER_STDOUT_WORLD,PETSC_VIEWER_FORMAT_ASCII_MATLAB,''MatB'');
...
\begin{verbatim}
   ierr = PetscViewerSetFormat(PetscViewer viewer,int format,char *name);
\end{verbatim}  
...
The routines
\begin{verbatim}
   ierr = PetscViewerPushFormat(PetscViewer viewer,int format,char *name);
...
\begin{verbatim}
ierr = PetscMalloc(n*sizeof(double),&(   ptr ));CHKPTRQ(void *ptr);
\end{verbatim}
