% $Id: part2.tex,v 1.184 1997/01/15 14:45:35 curfman Exp bsmith $ 
%
% NOTES:  
...
\begin{verbatim}
  ierr = TSPseudoSetUseLocalTimeStepIncrement(TS ts);
\end{verbatim}
or \findex{TSPseudoSetUseLocalTimeStepIncrement()} 
the option {\tt -ts\_pseudo\_local\_increment}. \findex{-ts_pseudo_local_increment}
