% $Id: part2.tex,v 1.357 2001/04/04 17:07:54 bsmith Exp bsmith $ 
%
% NOTES:  
...
\begin{verbatim}
   ...
   ierr = DARestoreLocalVector(DA da,Vec *l);
\end{verbatim}
...
\begin{verbatim}
   Scalar **f,**u;
   ...
   ierr = DAVecGetArray(DA da,Vec local,(void**)u);
   ierr = DAVecGetArray(DA da,Vec global,(void**)f);
   ...
      f[i][j] = u[i][j] - ...
   ...
   ierr = DAVecRestoreArray(DA da,Vec local,(void**)u);
   ierr = DAVecRestoreArray(DA da,Vec global,(void**)f);
\end{verbatim}
...
\begin{verbatim}
    ierr = DAGetColoring(da,IS_COLORING_GLOBAL,MATMPIAIJ,&iscoloring,&J);
