...
\findex{TaoSolve()} called using the routine
\begin{verbatim}
   TaoSolve(TaoSolver);
\end{verbatim}
\noindent
...
can be be set from the command line using the routine \sindex{options}
...
argument
is the variable vector at which the constraint function should be
evaluated.  
