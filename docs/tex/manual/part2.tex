% $Id: part2.tex,v 1.209 1997/04/04 01:53:09 curfman Exp curfman $ 
%
% NOTES:  
...
compiler.  Currently, one can set {\tt PETSC\_ARCH=sun4\_f90} to use
these routines on sun4 systems.  We hope to support other compilers as
well, but we will need assistance from vendors since the Fortran90/C
interface is not a defined standard.
