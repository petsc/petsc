% $Id: developers.tex,v 1.11 1998/07/02 15:45:24 bsmith Exp bsmith $ 
%
...
The PETSc error handler take two error codes: a generic and a specific.
...
\end{verbatim}
that, by default prints to standard error.
...
logging and profiling within ALICE.   
...
Currently PETSc does not provide C++ wrapper objects that could be composed,
but we hope to provide them someday.
