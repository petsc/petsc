% $Id: developers.tex,v 1.14 1999/03/11 04:03:12 bsmith Exp bsmith $ 
%
...
\vspace{0.5in} \\
{\rm This document is intended for use with PETSc 2.0.24}}
...
logging and profiling within the ALICE kernel.
