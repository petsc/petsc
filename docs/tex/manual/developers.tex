% $Id: developers.tex,v 1.8 1998/05/04 19:39:08 bsmith Exp bsmith $ 
%
...
The macro {\tt SETERRQ()} is defined in {\tt include/petscerror.h} 
\begin{verbatim}
...
\begin{itemize}
\item {\tt getcomm(PetscObject,MPI_Comm *)} obtains the MPI communicator associated
      with this object.
