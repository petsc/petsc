...
{\tt -tao\_lmm\_limit\_mu <double>}; the default value is $1$.
...
\min_\tau f(x_k + \tau d_k).
\]
The Newton line-search method can be set by using the TAO solver {\tt tao\_nls}.
...
can be set by using the TAO solver {\tt tao\_ntr}.  For the best efficiency, 
