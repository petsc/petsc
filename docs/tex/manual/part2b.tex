...
${\mu_0,2\mu_0,\frac{1}{2}\mu_0,-\frac{1}{2}\mu_0}$ depending upon the
values of 
...
\begin{tabular}{l|p{1.5in}|l|p{2.0in}}
Name & Value & Default & Description \\
{\tt -tao\_ntr\_ksp\_type} & nash, stcg, gltr & stcg & Type of Krylov subspace method to use when solving linear system \\
...
This method is set using the linearly-constrained augmented
