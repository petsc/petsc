% $Id: onepager.tex,v 1.21 1997/05/27 21:44:40 bsmith Exp curfman $ 
...
\vsp
\item \code{TS} - timestepping code for scalably solving 
...
RS/6000 workstations; IBM PCs running FreeBSD, Linux, or Windows NT; the Cray T3D/T3E;
the Intel Paragon; the IBM SP; the SGI Origin; and the Convex Exemplar.
