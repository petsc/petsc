...
class Importer(ihooks.ModuleImporter):
  def import_module(self, name, globals = None, locals = None, fromlist = None, dummy = None, level = 0):
  ...
  def find_head_package(self, parent, name):
    ...
    if parent and parent.__file__.endswith('.py') and parent.__name__.find('.') >= 0:
