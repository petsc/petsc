...
#     desc.append('  Fortran Linker Flags:   '+self.linkerFlags)
  ...
  def configureHelp(self, help):
    ...
    help.addArgument('Compilers', '-CXXFLAGS=<string>', nargs.Arg(None, '',   'Specify the C++ compiler and C++ linker options'))
  ...
  def generateCCompilerGuesses(self):
    ...
    if self.framework.argDB.has_key('CC'):
      ...
      if self.framework.argDB['with-mpi'] and self.framework.argDB['with-mpi-compilers']  and not self.framework.argDB['with-mpich']:
