...
class Configure(config.package.Package):
  def __init__(self, framework):
    ...
    self.download          = ['http://downloads.sourceforge.net/project/viennacl/1.7.x/ViennaCL-1.7.1.tar.gz',
                              'http://ftp.mcs.anl.gov/pub/petsc/externalpackages/ViennaCL-1.7.1.tar.gz' ]
    self.downloaddirname   = str('ViennaCL-1.7.1')
