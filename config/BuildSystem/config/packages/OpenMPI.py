...
class Configure(config.package.GNUPackage):
  def __init__(self, framework):
    ...
    self.download               = ['https://www.open-mpi.org/software/ompi/v2.1/downloads/openmpi-2.1.2.tar.gz',
                                   'http://ftp.mcs.anl.gov/pub/petsc/externalpackages/openmpi-2.1.2.tar.gz']
