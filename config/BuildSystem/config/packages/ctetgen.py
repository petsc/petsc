...
class Configure(config.package.GNUPackage):
  def __init__(self, framework):
    ...
    self.gitcommit         = '24ccac951f62c95eb442e67844616d68db9dc1cc'
    self.download          = ['git://https://bitbucket.org/petsc/ctetgen.git','http://ftp.mcs.anl.gov/pub/petsc/externalpackages/ctetgen-0.4.1.tar.gz']
    self.functions         = []
    self.includes          = []
    self.hastests          = 1
    return
