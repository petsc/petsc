  ...
  def Install(self):
    ...
    if self.installNeeded('ml'):
      ...
      try:
        ...
        output,err,ret  = PETSc.package.NewPackage.executeShellCommand('cd '+self.packageDir+'; ML_INSTALL_DIR='+self.installDir+'; export ML_INSTALL_DIR; make clean; make; make install', timeout=2500, log = self.framework.log)
      except RuntimeError, e:
      ...
      self.postInstall(output+err,'ml')
