...
class Configure(PETSc.package.NewPackage):
  def __init__(self, framework):
    ...
    self.download     = ['https://gforge.inria.fr/frs/download.php/30920/pastix_release_3725.tar.bz2',
                         'http://ftp.mcs.anl.gov/pub/petsc/externalpackages/pastix_release_3725.tar.bz2']
