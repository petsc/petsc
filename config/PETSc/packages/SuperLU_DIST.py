...
class Configure(PETSc.package.NewPackage):
  def __init__(self, framework):
    ...
    self.gitcommit  = '477ac4cb42240655cde9eb1e077f03af87b6c9fa' # v3.3-p1 @ 2013-04-10 & p1
    self.giturls    = ['https://bitbucket.org/petsc/pkg-superlu_dist.git']
    self.download   = ['http://ftp.mcs.anl.gov/pub/petsc/externalpackages/superlu_dist_3.3-p1.tar.gz']
