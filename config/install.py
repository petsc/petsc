...
class Installer(script.Script):
  ...
  def copyConf(self, src, dst):
    ...
    for line in oldFile.readlines():
      ...
      line = re.sub(re.escape(os.path.join(self.rootDir, 'bin')), self.installDir, line)
      line = re.sub(re.escape(os.path.realpath(os.path.join(self.rootDir, 'bin'))), self.installDir, line)
