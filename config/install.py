...
class Installer(script.Script):
  ...
  def copyConf(self, src, dst):
    ...
    for line in oldFile.readlines():
      line = re.sub(os.path.join(self.rootDir, self.arch), self.installDir, line)
      line = re.sub(self.rootDir, self.installDir, line)
      # paths generated by configure could be different link-path than whats used by user
      line = re.sub(os.path.realpath(os.path.join(self.rootDir, self.arch)), self.installDir, line)
      line = re.sub(os.path.realpath(self.rootDir), self.installDir, line)
