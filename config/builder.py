...
regressionParameters = {'src/sys/comm/examples/tests/ex1':    [{'numProcs': 2},
                        ...
                        'src/ksp/ksp/examples/tutorials/ex4': [{'numProcs': 1, 'args': '-info'},
                        ...
                        'src/ksp/ksp/examples/tutorials/ex54':[{'numProcs': 4, 'args': '-ne 40 -alpha 1.e-3 -ksp_monitor -ksp_type cg -ksp_norm_type unpreconditioned'},
                                                               {'numProcs': 4, 'args': '-ne 40 -alpha 1.e-3 -ksp_monitor -ksp_type cg -ksp_norm_type unpreconditioned -pc_gamg_type sa'}],
                        'src/ksp/ksp/examples/tutorials/ex55':[{'numProcs': 4, 'args': '-ne 40 -alpha 1.e-3 -ksp_monitor -ksp_type cg -ksp_norm_type unpreconditioned'},
                                                               {'numProcs': 4, 'args': '-ne 40 -alpha 1.e-3 -ksp_monitor -ksp_type cg -ksp_norm_type unpreconditioned -pc_gamg_type sa'}],
                        'src/ksp/ksp/examples/tutorials/ex56':[{'numProcs': 8, 'args': '-ne 11 -alpha 1.e-3 -ksp_monitor -ksp_type cg -ksp_norm_type unpreconditioned -pc_gamg_type sa'}],
