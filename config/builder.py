...
regressionParameters = {'src/sys/comm/examples/tests/ex1':    [{'numProcs': 2},
                        ...
                        'src/dm/impls/complex/examples/tests/ex1': [{'numProcs': 1, 'args': '-dim 3 -ctetgen_verbose 4 -dm_view ::ascii_info_detail -info -info_exclude null'},
                                                                    ...
                                                                    {'numProcs': 2, 'args': '-dim 2 -refinement_uniform 1 -interpolate 1 -dm_view ::ascii_info_detail -sf_type window -acknowledge_ompi_onesided_bug'},
                                                                    {'numProcs': 2, 'args': '-dim 2 -refinement_uniform 1 -interpolate 1 -dm_view ::ascii_latex -sf_type window -acknowledge_ompi_onesided_bug'},
                                                                    ...
                                                                    {'numProcs': 2, 'args': '-dim 2 -cell_simplex 0 -refinement_uniform 1 -interpolate 1 -dm_view ::ascii_info_detail -sf_type window -acknowledge_ompi_onesided_bug'},
                                                                    {'numProcs': 2, 'args': '-dim 2 -cell_simplex 0 -refinement_uniform 1 -interpolate 1 -dm_view ::ascii_latex -sf_type window -acknowledge_ompi_onesided_bug'}],
                        'src/dm/impls/complex/examples/tests/ex3': [{'numProcs': 1, 'args': '',
                                                                     'setup': './bin/pythonscripts/PetscGenerateFEMQuadrature.py 2 1 2 1 identity src/dm/impls/complex/examples/tests/ex3.h'},
                                                                    {'numProcs': 1, 'args': '-order 1'},
                                                                    {'numProcs': 1, 'args': '-order 2'},
                                                                    {'numProcs': 1, 'args': '-dim 3',
                                                                     'setup': './bin/pythonscripts/PetscGenerateFEMQuadrature.py 3 1 3 1 identity src/dm/impls/complex/examples/tests/ex3.h'},
                                                                    {'numProcs': 1, 'args': '-dim 3 -order 1'},
                                                                    {'numProcs': 1, 'args': '-dim 3 -order 2'},
                                                                    {'numProcs': 1, 'args': '-interpolate 1',
                                                                     'setup': './bin/pythonscripts/PetscGenerateFEMQuadrature.py 2 2 2 1 identity src/dm/impls/complex/examples/tests/ex3.h'},
