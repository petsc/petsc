...
regressionParameters = {'src/sys/comm/examples/tests/ex1':    [{'numProcs': 2},
                        ...
                        'src/dm/impls/complex/examples/tests/ex1': [{'numProcs': 1, 'args': '-dim 3 -dm_view_detail -info -info_exclude null'},
                                                                    {'numProcs': 1, 'args': '-dim 3 -refinement_limit 0.0625 -dm_view_detail -info -info_exclude null'}],
