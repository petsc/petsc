...
# Document changes in command line options here.
  optMap = [('with-64bit-indices','with-64-bit-indices'),('blas-lapack','blaslapack'),('c-blas-lapack','f2cblaslapack'),('cholmod','suitesparse'),('umfpack','suitesparse'),('f-blas-lapack','fblaslapack')]
  for opt in opts[1:]:
