...
do
  git checkout $commit
  git clean -f -d -x -q
  ./configure --with-clanguage=cxx --with-coverage-exec=0 --with-syclc=0 --with-hipc=0 --with-cudac=0 --with-x=0 --with-bison=0 --with-cmake=0 --with-pthread=0 --with-regexp=0 --with-mkl_sparse_optimize=0 --with-mkl_sparse=0 --with-debugging=0
  make vermin
